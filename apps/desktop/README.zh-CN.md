...
Orvilo Desktop 是 [Orvilo](https://github.com/alexj11324/orvilo1) 的跨平台桌面应用程序，使用 Electron 构建，提供了更加原生的桌面体验和功能。
...
- **问题和支持**：[GitHub Issues](https://github.com/alexj11324/orvilo1/issues)
