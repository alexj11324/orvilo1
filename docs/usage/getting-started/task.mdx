...
<Steps>
  ...
  Click **Tasks** in the left sidebar to open the task list for your workspace. To see work already assigned to you, open **My Work** instead — see [Inbox and My Work](/docs/usage/getting-started/work).
...
Approvals, assigned lists, saved views, and team triage live on [Inbox and My Work](/docs/usage/getting-started/work). **Tasks**, **Projects**, and **Automation** stay in the sidebar.
