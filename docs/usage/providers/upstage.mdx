---
title: Using Upstage in Orvilo
description: >-
  Learn how to configure and use Upstage's API Key in Orvilo to start
...
This guide will walk you through how to use Upstage within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in Orvilo
...
And that’s it! You’re now ready to use Upstage’s models for conversations in Orvilo.
