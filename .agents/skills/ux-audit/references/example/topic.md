...
AgentWorkingSidebar). Linear: ORVILO-11213 (under ORVILO-11145). 2026-07. Use as a template for
...
(same shape already cited for Task list / Eval / Memory / generation). → **ORVILO-11222**.
