---
title: Using the SambaNova API Key in Orvilo
description: >-
  Learn how to configure and use SambaNova models in Orvilo, obtain your API
...
# Using SambaNova in Orvilo

<Image alt={'Using SambaNova in Orvilo'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in Orvilo:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Orvilo

  - Go to the `App Settings` section in Orvilo
...
You're now ready to start chatting with models powered by SambaNova in Orvilo.
