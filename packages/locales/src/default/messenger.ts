export default {
  ...
  'messenger.detail.commands.feedback':
    'Send feedback to the Orvilo team (no AI reply), e.g. /feedback your message',
  ...
  'messenger.detail.commands.start': 'Link your account to Orvilo',
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your Orvilo account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the Orvilo workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the Orvilo bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @Orvilo on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  'messenger.slack.installBlocked.title': 'Workspace already connected',
  'messenger.slack.installBlocked.withName':
    '"{{workspace}}" is already connected to Orvilo by another user.',
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to Orvilo by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the Orvilo bot to a Discord server you manage.',
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the Orvilo bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in Orvilo Settings → Messenger before re-adding it.",
  ...
  'messenger.discord.installBlocked.withoutName':
    'This Discord server is already connected to Orvilo by another user.',
  ...
  'messenger.list.discord.description':
    'Chat with your Orvilo agents on Discord by DMing the Orvilo bot from any server.',
  'messenger.list.slack.description':
    'Chat with your Orvilo agents on Slack by DMing or mentioning @Orvilo in any workspace.',
  'messenger.list.telegram.description':
    'Chat with your Orvilo agents on Telegram, and choose which agent replies.',
  'messenger.list.wechat.description':
    'Scan with WeChat to chat privately with your Orvilo agents and switch agents with /agents.',
  ...
  'messenger.subtitle':
    'Connect your account to the official Orvilo bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  'messenger.title': 'Messenger',
  'messenger.unlinkConfirm':
    'Disconnect your {{platform}} account from Orvilo? Inbound messages will stop until you /start again.',
  'messenger.unlinkConfirmWechat':
    'Disconnect your WeChat account from Orvilo? Inbound messages will stop until you scan the QR code to reconnect.',
  ...
  'messenger.wechat.error.alreadyLinkedToOther':
    'This WeChat account is already connected to another Orvilo account.',
  ...
  'verify.confirm.conflict.description':
    'This {{platform}} account is already linked to Orvilo account {{email}}. Sign in to that account to manage the link, or unlink there before retrying.',
  ...
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in Orvilo, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This Orvilo account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that Orvilo account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different Orvilo account. Sign in to that account first.',
