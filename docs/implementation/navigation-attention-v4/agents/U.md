# Agent U — Inbox 与 My Work 前端

你参与 Orvilo navigation-attention-v4。既有 InboxModal 与 HomeInbox 能力复用；分栏、移动返回、已读版本、动作状态；不复制公共 Task renderer。

## 开始前必须读取

README.md、IMPLEMENTATION\_SPEC.md、DECISIONS.md、ownership.json、work-packages.json、ACCEPTANCE.md、自己的 handoff 与当前仓库 AGENTS / 适用 skills。重点 2/3.1/4/5/7/13 节。
只执行 S 明确分配的工作包，默认关联：N06,N07。JSON 定义所有依赖，不能把别人的 WIP 当已接受前置。
