...
description: >-
  Learn how to import and export configuration settings for Orvilo via URL.
...
Orvilo support import settings from external URL to quickly set up Orvilo configuration.
...
```plaintext
https://orvilo.aspectlylabs.com/?settings=<settings object in JSON format>
https://orvilo.aspectlylabs.com/?settings={"keyVaults":{"openai":{"apiKey":"user-key","baseURL":"https://your-proxy.com/v1"}}}
```
...
<Callout type={'warning'}>
  Orvilo does not verify the correctness of the settings parameters in the URL, nor provide
