...
function rehypeOrviloAgents() {
  return (tree: any) => {
    visit(tree, (node, index, parent) => {
      // Handle <orviloAgents .../> wrapped inside a <p> element
      ...
      // Handle bare <orviloAgents .../> raw node (self-closing or opening tag)
...
export default rehypeOrviloAgents;
