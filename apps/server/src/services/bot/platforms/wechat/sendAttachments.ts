import type { MessageItem, WechatApiClient } from '@orvilo/chat-adapter-wechat';
import { MessageItemType, WechatUploadMediaType } from '@orvilo/chat-adapter-wechat';
 ...
 * `SendMessageAttachment` (@orvilo/builtin-tool-message); both flow into
