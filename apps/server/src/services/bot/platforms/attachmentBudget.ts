import type { MessengerAttachmentBudget, MessengerOversizeImageStrategy } from '@orvilo/const';
import {
 ...
 *
 * The values live in `@orvilo/const` (MESSENGER_ATTACHMENT_BUDGETS) because
