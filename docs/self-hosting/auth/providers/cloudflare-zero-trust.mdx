---
title: Configuring Cloudflare Zero Trust Authentication for Orvilo
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for Orvilo, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for Orvilo. Use `cloudflare-zero-trust`                          |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use Orvilo.
</Callout>
