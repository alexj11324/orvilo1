---
title: Using SiliconCloud in Orvilo
description: >-
  Learn how to configure and use SiliconCloud's API Key in Orvilo to start
...
This guide will walk you through how to use SiliconCloud within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure SiliconCloud in Orvilo
...
That's it! You're now ready to use SiliconCloud's models for conversations in Orvilo.
