import type { GoalAdvanceEffect, GoalMetricCriteriaState } from '@orvilo/agent-tracing';
import { buildGoalRequirement } from '@orvilo/builtin-tool-goal';
import { GOAL_COORDINATOR_ACTOR_ID } from '@orvilo/const/goal';
import type {
  GoalConfig,
  GoalCreateConfig,
  GoalEdgeKind,
