...
export const NAVIGATION_ROUTES: NavigationRoute[] = [
  ...
  },
  {
    ...
    icon: Inbox,
    id: 'workInbox',
    keywords: ['inbox', 'notifications', 'attention'],
    keywordsKey: 'cmdk.keywords.inbox',
    path: '/inbox',
    pathPrefix: '/inbox',
    tier: 'primary',
  },
  {
    ...
    keywordsKey: 'cmdk.keywords.myWork',
    path: '/my-work',
    pathPrefix: '/my-work',
    tier: 'primary',
  },
  ...
  },
  {
    ...
    icon: LayoutList,
    id: 'savedViews',
    keywords: ['views', 'saved', 'filters'],
    keywordsKey: 'cmdk.keywords.views',
    path: '/views',
    pathPrefix: '/views',
    tier: 'primary',
  },
  {
    ...
    icon: Users,
    id: 'teams',
    keywords: ['teams', 'triage'],
    keywordsKey: 'cmdk.keywords.teams',
    path: '/teams',
    pathPrefix: '/teams',
    tier: 'primary',
  },
