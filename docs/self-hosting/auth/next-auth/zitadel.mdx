---
title: Configure ZITADEL Authentication Service for Orvilo
description: >-
  Learn how to configure ZITADEL Authentication Service for Orvilo deployment,
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that Orvilo is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use Orvilo using existing
