          ...
          tool_calls: [
            {
              function: {
                arguments: '{,',
                name: 'orvilo-user-memory____addPreferenceMemory',
              },
              id: 'call_bad',
              type: 'function',
            },
          ...
          tool_calls: [
            {
              function: {
                arguments: JSON.stringify({
                  ...
                  set: {
                    details: 'The user clarified that they maintain Orvilo Agent Signal code.',
                    summary: 'The user maintains Agent Signal memory receipt behavior.',
                    title: 'Maintains Agent Signal receipts',
                  },
                }),
                name: 'orvilo-user-memory____updateIdentityMemory',
              },
