...
/**
 * `@orvilo/types` declares these unions independently — it cannot import them
 * from here, because it must stay free of a dependency on `@orvilo/const`
...
describe('verify vocabulary', () => {
  it('matches the unions declared in @orvilo/types', () => {
