---
title: Connect Orvilo to Discord
description: >-
  Learn how to create a Discord bot and connect it to your Orvilo agent as a
  message channel, allowing your AI assistant to interact with users directly
...
# Connect Orvilo to Discord

By connecting a Discord channel to your Orvilo agent, users can interact with the AI assistant directly through Discord server channels and direct messages.
...
<Steps>
  ...
  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/83f435317ea2c9c4a2adcbfd74301536.png)

  Visit the [Discord Developer Portal](https://discord.com/developers/applications) and click **New Application**. Give your application a name (e.g., "Orvilo Assistant") and click **Create**.
  ...
  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/6126baa4154be45eefdad73c576723d0.png)
  ...
  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/e76272de65ad8db8746b1dcafeafdce8.png)
  ...
  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/d42901c6eb84e3e335d9a8535f317a35.png)
...
## Step 2: Configure Discord in Orvilo

<Steps>
  ### Open Channel Settings

  In Orvilo, navigate to your agent's settings, then select the **Channels** tab. Click **Discord** from the platform list.

  ### Fill in the Credentials

  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/c5ced26ea287ee215a9dc385367c1083.png)
  ...
  Click **Save Configuration**. Your credentials will be saved and Orvilo will start listening for Discord events.
</Steps>
...
<Steps>
  ...
  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/5e8a93f33e085a187deddb87704f0bd3.png)
  ...
  ![](https://hub-apac-1.objects.aspectlylabs.com/docs/d83686461d14690e87512491c1349b6b.webp)
...
Back in Orvilo's channel settings for Discord, click **Test Connection** to verify everything is configured correctly. Then send a message to your bot on Discord to confirm it responds.
...
To get it: in Discord, open **User Settings → Advanced** and turn on **Developer Mode**. Then right-click your own username anywhere in Discord and choose **Copy User ID**. Paste the numeric ID into **Your Platform User ID** in Orvilo's Advanced Settings.
...
To get it: with **Developer Mode** on, right-click the server name in your server list and choose **Copy Server ID**. Paste it into **Default Server** in Orvilo's Advanced Settings.

## Access Policies

Orvilo gates inbound traffic with three layered settings, all under **Advanced Settings** and all defaulting to permissive.
