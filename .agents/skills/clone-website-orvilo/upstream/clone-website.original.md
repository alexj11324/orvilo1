...
- **Don't reference docs from builder prompts.** Each builder gets the CSS spec inline in its prompt — never "see DESIGN\_TOKENS.md for colors." The builder should have zero need to read external docs.
