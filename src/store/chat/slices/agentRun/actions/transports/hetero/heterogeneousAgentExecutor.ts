...
import type {
  ...
  AgentStreamEvent,
} from '@orvilo/agent-gateway-client';
import type { HeterogeneousAgentSessionError } from '@orvilo/electron-client-ipc';
...
import { formatContextSelections, formatPageSelections } from '@orvilo/prompts';
import type {
  ChatMessageError,
  ChatToolPayload,
  ChatTopicMetadata,
 ...
 * (`AgentStreamPipeline` from `@orvilo/heterogeneous-agents/spawn`), so the
...
export const executeHeterogeneousAgent = async (
   ...
   * `@orvilo/heterogeneous-agents`. Owns the main turn/step state machine
