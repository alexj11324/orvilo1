---
title: Using Jina AI API Key in Orvilo
description: >-
  Learn how to configure and use Jina AI models in Orvilo, obtain your API key,
  and start chatting.
tags:
  - Orvilo
  - Jina AI
...
# Using Jina AI in Orvilo

<Image alt={'Using Jina AI in Orvilo'} cover src={'/blog/assetsc6ff27b7134f280727e1fd7ff83ed2fa.webp'} />
...
This guide will walk you through how to use Jina AI in Orvilo:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in Orvilo
...
And that’s it! You’re now ready to start chatting with models powered by Jina AI in Orvilo.
