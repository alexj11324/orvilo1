export default {
  ...
  'reviews.authorReviewCommentOnly': 'You can only comment on your own pull request',
  'reviews.backToPullRequests': 'Back to pull requests',
  'reviews.branch': 'Branch',
  'reviews.branchBehind': 'Behind {{branch}}',
  'reviews.branchNoConflicts': 'No conflicts with {{branch}}',
  ...
  'reviews.moreFilesInDiff': 'View more files in Diff',
  'reviews.openInGitHub': 'Open in GitHub',
  'reviews.overview': 'Overview',
  ...
  'teams.resources.addResources': 'Add resources',
  'teams.resources.addSection': 'Add section',
  'teams.resources.addToSection': 'Add document to {{name}}',
  'teams.resources.attach': 'Add',
  'teams.resources.attached': 'Added',
  'teams.resources.deleteSection': 'Delete section',
  'teams.resources.deleteSectionConfirm':
    'Delete this section? Its resources will move to the main list.',
  'teams.resources.editLink': 'Edit link',
  'teams.resources.existingDocuments': 'Existing documents',
  'teams.resources.invalidUrl': 'Enter a valid http or https link without credentials.',
  'teams.resources.loadMore': 'Load more',
  'teams.resources.moreActions': 'Resource actions',
  'teams.resources.moveToMain': 'Move to main list',
  'teams.resources.moveToSection': 'Move to {{name}}',
  'teams.resources.newDocument': 'New document',
  'teams.resources.newLink': 'New link…',
  'teams.resources.noDocuments': 'No documents available',
  'teams.resources.noPublicDocuments': 'No public documents available',
  'teams.resources.remove': 'Remove',
  'teams.resources.removeConfirm': 'Remove this resource from the team?',
  'teams.resources.renameSection': 'Rename section',
  'teams.resources.sectionActions': 'Actions for {{name}}',
  'teams.resources.sectionName': 'Section name',
  'teams.resources.titleOptional': 'Title (optional)',
  'teams.resources.untitled': 'Untitled',
  'teams.resources.url': 'URL',
  'teams.resourcesEmpty': 'Add documents and links. Organize by creating sections.',
  'teams.resourcesEmptyReadOnly': 'No resources for this team yet',
  'teams.snooze': 'Snooze',
