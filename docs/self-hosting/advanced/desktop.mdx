---
title: Automatic Synchronization with Orvilo Desktop
description: Configure Orvilo Desktop for a synchronized experience
tags:
  - Orvilo
...
# Automatic Synchronization with Orvilo Desktop

Orvilo Desktop provides users with an enhanced experience while also expanding the capabilities of Orvilo, allowing users to utilize Orvilo in offline environments. This document will guide you on how to configure Orvilo Desktop and connect it to your self-hosted instance.

## System Requirements

Orvilo Desktop is built using Electron and supports the following operating systems:
...
The version release of Orvilo Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of Orvilo Desktop.
...
Orvilo Desktop can connect to your self-hosted Orvilo instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying Orvilo using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
1. Open Orvilo Desktop.
2. Click the Wi-Fi icon in the upper right corner.
3. Enter the address of your self-hosted instance (e.g., `https://your-Orvilo-instance.com`).
...
- Example file names:
  - Apple Silicon: `Orvilo-Beta-1.83.6-arm64.dmg` or `Orvilo-Beta-1.83.6-arm64-mac.zip`
  - Intel: `Orvilo-Beta-1.83.6-x64.dmg` or `Orvilo-Beta-1.83.6-mac.zip`
