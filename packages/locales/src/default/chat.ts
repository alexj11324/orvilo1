export default {
  ...
  'chatHistory.switchAgentChat': 'Switch agent chat',
  ...
  'cliDetectionTimeoutGuide.desc':
    'Orvilo took too long to locate `{{command}}` from your login shell environment.',
  ...
  'goalDetail.taskResult': 'Issue result',
  'goalDetail.viewOriginalTask': 'View issue',
  'goalProcess.deliverables.empty':
    'Nothing delivered yet. Documents, generated files and linked resources an issue persists show up here — anything left only on a local path does not.',
  ...
  'taskList.truncated': 'Showing the first {{loaded}} of {{total}} issues',
  ...
  'examples.createProject.desc': 'Turn an idea into a well-scoped project',
  'examples.createProject.title': 'Create a new project',
  'examples.dismiss': 'Dismiss',
  'examples.draftUpdate.desc': 'Turn project progress into a clear update',
  'examples.draftUpdate.title': 'Draft a project update',
  'examples.researchTopic.desc': 'Research a topic across the issue backlog',
  'examples.researchTopic.title': 'Research a topic',
  'examples.title': 'Get started with some examples',
  ...
  'group.desc': 'Move an issue forward with multiple Agents in one shared space.',
  ...
  'heteroAgent.claudeQuota.calendar.empty':
    'Not enough usage history yet — run a few issues and check back.',
  ...
  'heteroAgent.claudeQuota.calendar.noLedgerSpendHint':
    'Token history is only recorded for runs started in Orvilo after usage tracking was enabled. Earlier usage and runs started directly from the terminal cannot be backfilled.',
  ...
  'heteroAgent.codexQuota.errorConnection':
    "Couldn't reach the Codex quota endpoint. Check your network or Orvilo proxy settings.",
  ...
  'ampInstallGuide.reason': 'Orvilo could not start Amp: {{message}}',
  ...
  'claudeCodeInstallGuide.reason': 'Orvilo could not start Claude Code: {{message}}',
  ...
  'codeBuddyInstallGuide.reason': 'Orvilo could not start CodeBuddy: {{message}}',
  ...
  'codexInstallGuide.reason': 'Orvilo could not start Codex: {{message}}',
  ...
  'cursorInstallGuide.reason': 'Orvilo could not start Cursor: {{message}}',
  ...
  'droidInstallGuide.reason': 'Orvilo could not start Factory Droid: {{message}}',
  ...
  'devinInstallGuide.reason': 'Orvilo could not start Devin: {{message}}',
  ...
  'grokBuildInstallGuide.reason': 'Orvilo could not start Grok Build: {{message}}',
  ...
  'opencodeInstallGuide.reason': 'Orvilo could not start OpenCode: {{message}}',
  ...
  'piInstallGuide.reason': 'Orvilo could not start Pi: {{message}}',
  ...
  'qoderInstallGuide.reason': 'Orvilo could not start Qoder: {{message}}',
  ...
  'kimiCodeInstallGuide.reason': 'Orvilo could not start Kimi Code: {{message}}',
  ...
  'connectAgent.create.doneHint': 'All set — open one to give it its first issue.',
  ...
  'operation.execServerAgentRuntime':
    'Issue is running in the server. You are safe to leave this page',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through Orvilo's Agent Gateway. Issues keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'Orvilo optimized search service, delivering best retrieval results.',
  ...
  'chatMode.agentDesc': 'Agent can use tools and environment to complete issues automatically',
  ...
  'sendPlaceholder': 'Ask, create, or start an issue, <hotkey><hotkey/>',
  ...
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not Orvilo's, and Orvilo takes no responsibility for it.",
  ...
  'task.instruction': 'Issue Instruction',
  ...
  'task.status.cancelled': 'Issue Cancelled',
  'task.status.failed': 'Issue Failed',
  'task.status.fetchingDetails': 'Fetching details...',
  'task.status.initializing': 'Initializing issue...',
  ...
  'taskDetail.prerequisites.title': 'Prerequisite issues',
  ...
  'taskDetail.prerequisites.empty': 'No prerequisite issues.',
  'taskDetail.prerequisites.input': 'Prerequisite issue identifier',
  'taskDetail.prerequisites.placeholder': 'Issue identifier, e.g. T-1',
  'taskDetail.prerequisites.add': 'Add',
  'taskDetail.prerequisites.remove': 'Remove prerequisite {{identifier}}',
  'taskDetail.prerequisites.cycle': 'This dependency would create a cycle.',
  'taskDetail.prerequisites.self': 'An issue cannot depend on itself.',
  'taskDetail.prerequisites.project': 'Prerequisites must belong to the same project.',
  'taskDetail.prerequisites.active':
    'Pause or reopen this issue before adding an unfinished prerequisite.',
  'taskDetail.prerequisites.unavailable': 'Issue not found or unavailable.',
  ...
  'taskDetail.acceptance.removeConfirm.content':
    "This removes the issue's acceptance goal, checklist, and recorded acceptance results. Issue artifacts are unaffected.",
  ...
  'taskDetail.artifactMenu.delete': 'Remove from issue',
  'taskDetail.artifactMenu.deleteConfirm.content':
    'This artifact will no longer appear in this issue workspace.',
  ...
  'taskDetail.activities.assignment.memberAssigned': '<actor/> assigned the issue to <target/>',
  'taskDetail.activities.assignment.memberUnassigned': '<actor/> removed the assignee',
  'taskDetail.activities.assignment.reviewerAssigned': '<actor/> set the reviewer to <target/>',
  'taskDetail.activities.assignment.reviewerUnassigned': '<actor/> removed the reviewer',
  ...
  'taskDetail.deleteConfirm.title': 'Delete this issue?',
  'taskDetail.instruction': 'Instruction',
  'taskDetail.modelConfig': 'Model Override',
  'taskDetail.saveModelConfig': 'Save',
  'taskDetail.instructionPlaceholder': 'Add issue instruction...',
  'taskDetail.labels.create': 'Create label "{{name}}"',
  'taskDetail.labels.createFailed': 'Could not create the label. Try again.',
  'taskDetail.labels.disabled': 'Labels cannot be changed while the issue is running',
  'taskDetail.labels.empty': 'No labels yet',
  'taskDetail.labels.searchPlaceholder': 'Search or create labels…',
  'taskDetail.labels.title': 'Labels',
  'taskDetail.labels.add': 'Add label',
  'taskDetail.labels.updateFailed': 'Could not update labels. Try again.',
  ...
  'taskDetail.pauseTask': 'Pause issue',
  ...
  'taskDetail.relations.addTo': 'Add relation to {{title}}',
  'taskDetail.openProject': 'Open project',
  'taskDetail.moreActions': 'More actions',
  ...
  'taskDetail.milestone.updateFailed': 'Could not update the milestone. Try again.',
  ...
  'taskDetail.statusCascade.applyFailed': 'Could not update the issue status. Try again.',
  'taskDetail.statusCascade.cancel': 'Cancel',
  'taskDetail.statusCascade.description':
    'This issue still has {{count}} open sub-issue(s). Update them to {{status}} too?',
  'taskDetail.statusCascade.loadFailed': 'Could not check the sub-issue statuses. Try again.',
  'taskDetail.statusCascade.parentOnly': 'Update parent only',
  'taskDetail.statusCascade.title': 'Update open sub-issues too?',
  'taskDetail.statusCascade.updateAll': 'Update all',
  'taskDetail.subtasks': 'Sub-issues',
  'taskDetail.addSubtask': 'Add sub-issue',
  'taskDetail.subtaskInstructionPlaceholder': 'Describe the sub-issue...',
  'taskDetail.runAll': 'Run all',
  'taskDetail.runAll.title': 'Run sub-issues in dependency order',
  'taskDetail.runAll.description':
    'Sub-issues will run layer by layer. Each layer waits for the previous one to finish. Issues with no dependencies run in layer 1.',
  ...
  'taskDetail.runAll.skipped.alreadyDone':
    '{{count}} issue(s) already completed or canceled — skipped',
  'taskDetail.runAll.skipped.ineligible': '{{count}} issue(s) running or scheduled — skipped',
  'taskDetail.runAll.skipped.blockedExternally':
    '{{count}} issue(s) waiting on a blocker outside this batch — will run automatically when unblocked',
  'taskDetail.runAll.cycleWarning':
    'Circular dependency detected. Issues involved in or blocked by the cycle will not run: {{members}}',
  'taskDetail.runAll.empty':
    'Nothing to run — every sub-issue is already completed, in flight, or stuck in a cycle.',
  'taskDetail.runAll.confirm': 'Run {{count}} sub-issue(s)',
  'taskDetail.runAll.cancel': 'Cancel',
  'taskDetail.runAll.kickedOff': 'Started {{count}} sub-issue(s); downstream layers will follow.',
  'taskDetail.runAll.partialFailure':
    'Started {{ok}} of {{total}} sub-issue(s); {{failed}} failed.',
  'taskDetail.runAll.loading': 'Loading sub-issue plan...',
  'taskDetail.reassignDisabled': 'Cannot reassign agent while issue is running',
  'taskDetail.reviewer': 'Reviewer',
  'taskDetail.titlePlaceholder': 'Issue title',
  ...
  'taskDetail.topicMenu.stopConfirm.content':
    'The current run will be canceled. Generated messages are kept and you can re-run the issue later.',
  ...
  'taskDetail.integration.conflicts': 'Conflicting files: {{files}}',
  'taskDetail.integration.mergeRun': 'Merge run',
  'taskDetail.integration.openPr': 'Open pull request',
  'taskDetail.integration.recheck': 'Check again',
  'taskDetail.integration.retryFailed': 'Could not retry delivery',
  'taskDetail.integration.retryPublish': 'Retry publish',
  'taskDetail.integration.retryStarted': 'Delivery check completed',
  'taskDetail.integration.state.blocked': 'Merge blocked',
  'taskDetail.integration.state.conflict': 'Merge conflict',
  'taskDetail.integration.state.integrated': 'Merged',
  'taskDetail.integration.state.merging': 'Merging',
  'taskDetail.integration.state.pending': 'Awaiting merge',
  'taskDetail.integration.state.publish_failed': 'Publish failed',
  'taskDetail.integration.state.skipped': 'Merge skipped',
  'taskDetail.integration.state.verification_pending': 'Verification unavailable',
  'taskDetail.linearSync.source': 'Linear source',
  'taskDetail.linearSync.conflictFields': 'Conflicting fields: {{fields}}',
  'taskDetail.linearSync.openIssue': 'Open Linear issue',
  'taskDetail.linearSync.state.conflict': 'Sync conflict',
  'taskDetail.linearSync.state.outcomeUnknown': 'Sync outcome unknown',
  'taskDetail.linearSync.state.pending': 'Pending sync',
  'taskDetail.linearSync.state.removed': 'Removed from Linear',
  'taskDetail.linearSync.state.synced': 'Synced',
  'taskDetail.linearSync.state.unlinked': 'Unlinked',
  'taskDetail.workflow.businessStatus': 'Business status',
  'taskDetail.workflow.category.backlog': 'Backlog',
  'taskDetail.workflow.category.canceled': 'Canceled',
  'taskDetail.workflow.category.done': 'Done',
  'taskDetail.workflow.category.in_progress': 'In progress',
  'taskDetail.workflow.category.in_review': 'In review',
  ...
  'taskDetail.updateFailed': 'Failed to update issue',
  'taskDetail.publishToWorkspace.menuLabel': 'Publish to Workspace',
  'taskDetail.publishToWorkspace.confirmTitle': 'Publish issue to workspace?',
  ...
  'taskDetail.publishToWorkspace.errorPrivateAgent':
    'This issue is assigned to a private agent. Reassign to a workspace agent, or publish the agent first.',
  ...
  'createGoal.parallelismLabel': 'Parallel issues',
  'createGoal.parallelismPlaceholder': 'Auto',
  'createGoal.parallelismUnit': 'issues at once',
  'createGoal.parallelismHint':
    'Independent issues run in parallel up to this many; leave blank for the default.',
  ...
  'createTask.createFailed': 'Failed to create issue',
  'createTask.expandToInline': 'Dock to page',
  'createTask.instructionPlaceholder': 'Add issue instruction...',
  'createTask.submit': 'Create issue',
  'createTask.team': 'Team',
  'createTask.titlePlaceholder': 'Issue title',
  'createTask.visibility.changeFailed': 'Failed to change issue visibility',
  'createTask.visibility.helperPrivate': 'Only you can see this issue.',
  'createTask.visibility.helperWorkspace': 'Everyone in this workspace can see this issue.',
  'createTask.visibility.label': 'Visibility',
  'createTask.visibility.memberAssigneeLocked':
    'An issue with an Assignee stays visible to the workspace.',
  'createTask.visibility.privateAgentDisabled':
    'Private agents can only run private issues. Pick a workspace agent or switch this issue to Private.',
  'createTask.visibility.privateAgentLocked': 'Private agents can only run private issues.',
  ...
  'taskIntent.created': 'Issue created',
  ...
  'goalList.taskProgress': '{{done}}/{{total}} issues done',
  'goalList.findings': '{{count}} findings',
  'goalList.needsYou': '{{count}} need you',
  'goalList.noTasks': 'No issues yet',
  ...
  'goalTask.tasksDone': '{{passed}}/{{total}} issues done',
  ...
  'goalDetail.executionOverviewDescription':
    'The complete issue tree and latest runs for this goal.',
  'goalDetail.instruction': 'Goal instruction',
  'goalDetail.latestRuns': 'Recent executions',
  'goalDetail.deleteConfirm.content':
    'This goal and its issue plan will be permanently deleted. Conversation history is retained.',
  ...
  'goalDetail.metrics.taskExecutions': 'Issue executions',
  ...
  'goalDetail.openExecution': 'Open execution issue',
  'goalDetail.subtasks': 'Sub-issues',
  'goalDetail.taskStatus': 'Execution status',
  'goalDetail.unnamedRun': 'Untitled run',
  'goalDetail.viewPlan': 'View execution plan',
  'goalProcess.frontier.title': 'Current issues',
  ...
  'goalProcess.frontier.add': 'Add issue',
  ...
  'goalProcess.frontier.emptyDescription':
    'Every issue is either waiting on a dependency or already finished.',
  ...
  'goalProcess.addTask.failed': 'Failed to add the issue — please try again',
  'goalProcess.addTask.titleLabel': 'Issue title',
  'goalProcess.addTask.titlePlaceholder': 'What should this issue deliver?',
  ...
  'goalProcess.planning.description':
    'The coordinator is breaking the goal into executable issues — they will appear here shortly.',
  ...
  'goalProcess.gate.title.recoverTask': 'Decide what happens to the failed issue',
  ...
  'goalProcess.gate.reason.verifyFailed': 'Issue {{id}} did not pass verification',
  ...
  'goalProcess.metricDetail.budget.parallelism': 'Parallel issues',
  ...
  'goalProcess.metricDetail.duration.taskSpans': 'Issue spans',
  ...
  'goalProcess.metricDetail.liveness.driver':
    'The goal advances on its own: each finished issue triggers the next move, and a recovery sweep rescues anything that stalls or loses its device. Nothing here waits for you unless a decision gate is open.',
  ...
  'goalProcess.metricDetail.tasks.title': 'All issues',
  ...
  'goalProcess.node.openTask': 'Open issue detail',
  ...
  'goalProcess.metrics.tasks': 'Issues',
  ...
  'goalProcess.node.verifierTooltip':
    'This issue has its own acceptance contract — a verifier judges the delivery.',
  'goalProcess.node.artifactsTooltip':
    '{{count}} work versions registered. Opening them needs a server read that does not exist yet.',
  'goalProcess.node.humanTouched': 'You took part in this issue',
  ...
  'taskList.activeTasks': 'Active Issues',
  'taskList.all': 'All issues',
  'taskList.visibility.all': 'All',
  'taskList.visibility.label': 'Visibility',
  'taskList.breadcrumb.task': 'Issue',
  // Board-card meta line — Linear stamps "Created <date>" on every card.
  'taskList.createdAt': 'Created {{date}}',
  'taskList.empty': 'No issues yet',
  'taskList.form.columns': 'Columns',
  'taskList.form.grouping': 'Grouping',
  'taskList.form.milestones': 'Milestones',
  'taskList.form.nestedSubTasks': 'Nested sub-issues',
  'taskList.form.orderCompletedByRecency': 'Sort completed issues by recency',
  'taskList.form.ordering': 'Ordering',
  'taskList.form.reset': 'Reset',
  'taskList.form.setDefault': 'Set default',
  'taskList.form.showCompleted': 'Show completed & canceled',
  'taskList.form.showSubTasks': 'Show sub-issues',
  'taskList.form.subGrouping': 'Sub-grouping',
  'taskList.hiddenCompleted.count_one': '{{count}} issue',
  'taskList.hiddenCompleted.count_other': '{{count}} issues',
  ...
  'taskList.groupBy.milestone': 'Milestone',
  ...
  'taskList.orderBy.manual': 'Manual',
  ...
  'taskList.mine.emptyAssigned': 'No issues assigned to you yet',
  'taskList.mine.emptyCreated': "You haven't created any issues yet",
  'taskList.mine.title': 'My issues',
  ...
  'taskList.subtaskProgress.loadFailed':
    "Couldn't load sub-issues. Click the progress badge to retry.",
  'taskList.title': 'Issues',
  'taskList.milestoneFilter': 'Milestone: {{name}}',
  'taskList.milestoneFilterClear': 'Clear milestone filter',
  'taskList.filter.add': 'Add filter',
  'taskList.filter.advanced': 'Advanced filter',
  'taskList.filter.ai': 'AI filter',
  'taskList.filter.aiHint': 'Describe the issues to show — e.g. "urgent bugs assigned to me".',
  'taskList.filter.aiNoMatch': 'Nothing matched — try naming a status, priority, person or label.',
  'taskList.filter.aiPlaceholder': 'Filter with words…',
  'taskList.filter.anyMilestone': 'Any milestone',
  'taskList.filter.apply': 'Apply',
  'taskList.filter.back': 'Back',
  'taskList.filter.clearAll': 'Clear all',
  'taskList.filter.dateFields.completed': 'Completed date',
  'taskList.filter.dateFields.created': 'Created date',
  'taskList.filter.dateFields.updated': 'Updated date',
  'taskList.filter.groups.agent': 'Agent',
  'taskList.filter.groups.assignee': 'Assignee',
  'taskList.filter.groups.creator': 'Creator',
  'taskList.filter.groups.dates': 'Dates',
  'taskList.filter.groups.labels': 'Labels',
  'taskList.filter.groups.links': 'Links',
  'taskList.filter.groups.milestone': 'Milestone',
  'taskList.filter.groups.priority': 'Priority',
  'taskList.filter.groups.relations': 'Relations',
  'taskList.filter.groups.status': 'Status',
  'taskList.filter.groups.subscribers': 'Subscribers',
  'taskList.filter.groups.template': 'Template',
  'taskList.filter.groups.text': 'Title & description',
  'taskList.filter.groups.triage': 'Triage',
  'taskList.filter.loading': 'Loading…',
  'taskList.filter.membersError': 'Couldn’t load members',
  'taskList.filter.noAgent': 'No agent',
  'taskList.filter.noAssignee': 'No assignee',
  'taskList.filter.noCreator': 'No creator',
  'taskList.filter.noLabels': 'No labels',
  'taskList.filter.noLabelsDefined': 'No labels yet',
  'taskList.filter.noMatches': 'No matches',
  'taskList.filter.noMenuMatches': 'No matching filters',
  'taskList.filter.notInTriage': 'Not in triage',
  'taskList.filter.removeChip': 'Remove filter',
  'taskList.filter.searchMembers': 'Search members…',
  'taskList.filter.searchPlaceholder': 'Search filters…',
  'taskList.filter.textPlaceholder': 'Title or description contains…',
  'taskList.filter.unavailable': 'Not supported for issues yet',
  'taskList.filter.windows.past': 'In the past',
  'taskList.filter.windows.past30': 'In the last 30 days',
  'taskList.filter.windows.set': 'Is set',
  'taskList.filter.windows.unset': 'Is not set',
  'taskList.detail.close': 'Close',
  ...
  'taskList.unassignedAgentHint': 'Orvilo AI will run this issue when no agent is selected',
  ...
  'taskList.contextMenu.copyDescription':
    'Clone this issue (and all its sub-issues) into another workspace. Status resets to backlog.',
  'taskList.contextMenu.copyFailed': 'Failed to copy issue',
  ...
  'taskList.contextMenu.copySuccess': 'Issue copied',
  'taskList.contextMenu.copyTitle': 'Copy issue',
  ...
  'taskList.contextMenu.transferDescription':
    'Move this issue (and all its sub-issues) to another workspace. Identifiers will be re-assigned.',
  'taskList.contextMenu.transferFailed': 'Failed to move issue',
  'taskList.contextMenu.transferSuccess': 'Issue moved',
  'taskList.contextMenu.transferTitle': 'Move issue',
  ...
  'taskList.kanban.addTask': 'Create issue',
  ...
  'taskList.kanban.emptyColumn': 'No issues',
  ...
  'workingPanel.progress.allCompleted': 'All issues completed',
  ...
  'workingPanel.works.taskDeleted': 'This issue has been deleted',
  ...
  'verifyConfig.collapsedHint': 'Generate criteria from the issue',
  ...
  'internalLink.preview.task': 'Issue',
