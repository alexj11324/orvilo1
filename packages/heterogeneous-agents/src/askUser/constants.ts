 ...
 * countdown (`@orvilo/shared-tool-ui/ask-user` `draft.ts`
 * `DEFAULT_COUNTDOWN_MS`) mirrors this value and must be kept in sync (that
 * package has no dep on this one, so it can't import the const directly).
 */
