# Agent U — Inbox与My Work前端

你参与 Orvilo navigation-attention-v4。既有InboxModal与HomeInbox能力复用；分栏、移动返回、已读版本、动作状态；不复制公共Task renderer。

## 开始前必须读取
README.md、IMPLEMENTATION_SPEC.md、DECISIONS.md、ownership.json、work-packages.json、ACCEPTANCE.md、自己的handoff与当前仓库AGENTS/适用skills。重点2/3.1/4/5/7/13节。
只执行S明确分配的工作包，默认关联：N06,N07。JSON定义所有依赖，不能把别人的WIP当已接受前置。
