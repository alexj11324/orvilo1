import type { GroupContextMemberInfo } from '@orvilo/prompts';
 ...
 * Re-export from @orvilo/prompts for convenience
 */
...
export class GroupContextInjector extends BaseFirstUserContentProvider {
   ...
   * Uses template from @orvilo/prompts with direct variable replacement
   */
  private buildGroupContextBlock(): string {
    ...
    // Use formatGroupMembers from @orvilo/prompts
