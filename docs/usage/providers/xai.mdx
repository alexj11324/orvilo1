---
title: Using xAI in Orvilo
description: >-
  Learn how to configure and use xAI's API Key in Orvilo to start chatting and
  interacting.
tags:
  - Orvilo
  - xAI
...
This guide will walk you through how to use xAI within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure xAI in Orvilo
...
You’re now ready to start using xAI-powered models in Orvilo for conversations and interactions.
