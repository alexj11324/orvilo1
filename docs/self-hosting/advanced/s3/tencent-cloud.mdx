...
<Steps>
  ...
  Name the bucket (e.g., 'orvilo'). Choose 'Public Read, Private Write', select any region, and keep other settings default.
  ...
  ```shell
  S3_BUCKET=orvilo-130xxxxxx2
  S3_ENDPOINT=https://cos.ap-chengdu.myqcloud.com
  S3_REGION=ap-chengdu
  ```

  <Callout type={'warning'}>
    Note: `S3_ENDPOINT` should be `https://cos.ap-chengdu.myqcloud.com`, not `https://orvilo-130xxxxxx2.cos.ap-chengdu.myqcloud.com`
