...
import type { FetchEventSourceInit } from '@orvilo/utils/client/fetchEventSource/index';
import { fetchEventSource } from '@orvilo/utils/client/fetchEventSource/index';
...
vi.mock('@orvilo/utils/client/fetchEventSource/index', () => ({
