...
title: Testing Guide
description: >-
  Explore Orvilo's testing strategy, including unit testing with Vitest and
...
Orvilo's testing strategy includes unit testing with [Vitest][vitest-url] and end-to-end (E2E) testing with Playwright + Cucumber. This guide covers how to write and run tests effectively.
...
```typescript
// ✅ Good — accessible queries match what users
