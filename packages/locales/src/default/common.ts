export default {
  ...
  'cmdk.keywords.tasks': 'issues todo agent kanban',
  ...
  'cmdk.search.task': 'Issue',
  'cmdk.search.tasks': 'Issues',
  ...
  'globalSearch.placeholder': 'Search issues, projects, views…',
  ...
  'taskTemplate.action.create.error': 'Failed to create issue. Please try again.',
  'taskTemplate.action.create.success': 'Scheduled issue added. Find it in Orvilo AI.',
  'taskTemplate.action.createButton': 'Add issue',
  ...
  'taskTemplate.schedule.editableAfterCreateTooltip':
    'You can adjust the schedule after creating the issue.',
  'taskTemplate.schedule.weekly': 'Every {{weekday}} at {{time}}',
  'taskTemplate.section.title': 'Try these scheduled issues',
  ...
  'myWork.subscribeFailed': 'Could not subscribe to this issue',
  ...
  'myWork.unsubscribeFailed': 'Could not unsubscribe from this issue',
  'myWork.layoutBoard': 'Board',
  'myWork.layoutList': 'List',
  'myWork.moveBlocked': 'Finish blocking work before moving this to Done',
  'myWork.moveConflict': 'This issue changed. Refresh and move it again.',
  'myWork.moveFailed': 'Could not move this issue',
  ...
  'myWork.externalReviewsEmpty':
    'Readable GitHub or Linear review requests appear here. Issues are not created just to fill this list.',
  ...
  'teams.canonical': 'Canonical issue',
  ...
  'teams.actions': 'Team actions',
  'teams.addResources': 'Add resources',
  'teams.addSection': 'Add section',
  'teams.copyTeamUrl': 'Copy team URL',
  'teams.navSettings': 'Team settings',
  ...
  'teams.transferConflict': 'This issue changed. Refresh and move it again.',
  'teams.transferFailed': 'Could not move this issue',
  ...
  'teams.triageDirection': 'Direction',
  'teams.triageDueDate': 'Due date',
  'teams.triageEmpty': 'Nothing to triage',
  'teams.triageFailed': 'Could not update triage',
  'teams.triageId': 'ID',
  'teams.triageOrderingAdded': 'Added to triage',
  'teams.triageShowSnoozed': 'Show snoozed',
  'teams.triageUnsupported': 'Not supported yet',
  ...
  'teams.markDuplicateEmpty': 'No matching issue',
  'teams.markDuplicateHint':
    'Pick the issue this one duplicates. Only issues you can read are listed.',
  'teams.markDuplicatePlaceholder': 'Search issues by name or key…',
  'teams.markDuplicatePrompt': 'Type to search for the canonical issue.',
  ...
  'teams.workEmpty': 'No issues in this team',
  ...
  'taskDock.status.error': 'Some issues need attention',
