...
你参与 Orvilo navigation-attention-v4。既有 notificationRouter 演进，多消费者回执、live ActionSource、审批 /input/PR/ 转移回执；禁止通知操作代替审批。

## 开始前必须读取

README.md、IMPLEMENTATION\_SPEC.md、DECISIONS.md、ownership.json、work-packages.json、ACCEPTANCE.md、自己的 handoff 与当前仓库 AGENTS / 适用 skills。重点 3/4/8/9/13 节。
只执行 S 明确分配的工作包，默认关联：N04,N05,N10。JSON 定义所有依赖，不能把别人的 WIP 当已接受前置。
