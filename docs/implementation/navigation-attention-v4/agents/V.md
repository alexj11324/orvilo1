# Agent V — 团队、Views 与导航前端

你参与 Orvilo navigation-attention-v4。Team/Views/Favorites、公用 Task 呈现、路由 / 命令菜单 / 多端 /i18n；Tasks/Automation 和退休边界不回归。

## 开始前必须读取

README.md、IMPLEMENTATION\_SPEC.md、DECISIONS.md、ownership.json、work-packages.json、ACCEPTANCE.md、自己的 handoff 与当前仓库 AGENTS / 适用 skills。重点 2/5/6/7/10/13 节。
只执行 S 明确分配的工作包，默认关联：N08,N09。JSON 定义所有依赖，不能把别人的 WIP 当已接受前置。
