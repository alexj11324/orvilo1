---
title: Using Vercel AI Gateway in Orvilo
description: Learn how to integrate and use the unified API of Vercel AI Gateway in Orvilo
tags:
  - Orvilo
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in Orvilo
...
This guide will walk you through how to use Vercel AI Gateway within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Orvilo
...
That's it! You can now start chatting in Orvilo using models provided by Vercel AI Gateway.
