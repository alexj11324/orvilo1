 ...
 *
 * Kept in `@orvilo/const` (instead of inline in a router) so both the
 ...
 *
 * The builtin slugs are duplicated here rather than imported: `@orvilo/const`
 * sits *below* `@orvilo/builtin-agents` in the dependency graph. The copy is
