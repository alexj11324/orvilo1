---
title: Orvilo Feature Flags Environment Variables Configuration Guide
description: >-
  Learn how to use environment variables to customize Orvilo's feature flags,
...
In addition to basic environment variable configuration, Orvilo also offers feature flags to control whether a feature is enabled globally, or to enable or disable features for specific user groups or environments as needed.
...
You can always check the [featureFlags](https://github.com/alexj11324/orvilo1/blob/main/packages/app-config/src/featureFlags/schema.ts) to get the latest list of feature flags.
