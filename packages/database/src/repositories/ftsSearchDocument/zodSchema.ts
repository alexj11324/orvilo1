import type { FtsSearchDocumentEntity } from '@orvilo/types';
import { z } from 'zod';

export type { FtsSearchDocumentEntity } from '@orvilo/types';
export { FTS_SEARCH_DOCUMENT_ENTITIES } from '@orvilo/types';
