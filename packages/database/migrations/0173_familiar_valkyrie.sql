CREATE TABLE "linear_sync_scopes" (
...
CREATE TABLE "linear_team_links" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"workspace_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "team_repo_defaults" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"team_id" text NOT NULL,
	"repository_id" text NOT NULL,
	"workspace_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "team_workflow_states" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"team_id" text NOT NULL,
	"workspace_id" text NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "projects" DROP CONSTRAINT "projects_coordinator_agent_id_agents_id_fk";
--> statement-breakpoint
...
ALTER TABLE "linear_issue_links" ADD COLUMN "linear_team_id" text;--> statement-breakpoint
ALTER TABLE "linear_issue_links" ADD COLUMN "alias_identifiers" text[] DEFAULT '{}' NOT NULL;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "scope_id" uuid;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "sync_state" text DEFAULT 'synced' NOT NULL;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "last_confirmed_snapshot" jsonb;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "remote_snapshot" jsonb;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "conflict" jsonb;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "tombstone" jsonb;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "last_inbound_delivery_id" text;--> statement-breakpoint
ALTER TABLE "linear_project_bindings" ADD COLUMN "last_outbound_revision" bigint DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "task_domain_events" ADD COLUMN "team_id" text;--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN "created_by_subject_kind" text DEFAULT 'user' NOT NULL;--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN "created_by_subject_id" text;--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN "created_by_snapshot" jsonb;--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN "migration_class" text DEFAULT 'undetermined' NOT NULL;--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "team_id" text;--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "workflow_state_ref_id" uuid;--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "cycle_ref_id" uuid;--> statement-breakpoint
...
CREATE UNIQUE INDEX "linear_sync_scopes_installation_unique" ON "linear_sync_scopes" USING btree ("installation_id");--> statement-breakpoint
CREATE INDEX "linear_sync_scopes_workspace_id_idx" ON "linear_sync_scopes" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "linear_sync_scopes_status_idx" ON "linear_sync_scopes" USING btree ("status","locked_until");--> statement-breakpoint
CREATE UNIQUE INDEX "linear_team_links_workspace_team_unique" ON "linear_team_links" USING btree ("workspace_id","team_id");--> statement-breakpoint
CREATE UNIQUE INDEX "linear_team_links_workspace_linear_team_unique" ON "linear_team_links" USING btree ("workspace_id","linear_team_id");--> statement-breakpoint
CREATE INDEX "linear_team_links_installation_id_idx" ON "linear_team_links" USING btree ("installation_id");--> statement-breakpoint
CREATE INDEX "linear_team_links_sync_state_idx" ON "linear_team_links" USING btree ("workspace_id","sync_state");--> statement-breakpoint
CREATE UNIQUE INDEX "association_decisions_workspace_idempotency_unique" ON "association_decisions" USING btree ("workspace_id","idempotency_key");--> statement-breakpoint
CREATE INDEX "association_decisions_source_idx" ON "association_decisions" USING btree ("workspace_id","source_kind","source_id");--> statement-breakpoint
CREATE INDEX "association_decisions_target_idx" ON "association_decisions" USING btree ("target_repository_id");--> statement-breakpoint
CREATE INDEX "association_decisions_status_idx" ON "association_decisions" USING btree ("workspace_id","status");--> statement-breakpoint
...
CREATE INDEX "project_repositories_workspace_id_idx" ON "project_repositories" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "repositories_remote_identity_unique" ON "repositories" USING btree ("workspace_id","provider_host","remote_repository_id") WHERE "repositories"."remote_repository_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "repositories_local_only_unique" ON "repositories" USING btree ("workspace_id","local_only_key") WHERE "repositories"."local_only_key" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "repositories_workspace_id_idx" ON "repositories" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "repositories_status_idx" ON "repositories" USING btree ("workspace_id","status");--> statement-breakpoint
CREATE UNIQUE INDEX "repository_checkouts_device_path_unique" ON "repository_checkouts" USING btree ("device_id","canonical_path") WHERE "repository_checkouts"."device_id" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "repository_checkouts_repository_idx" ON "repository_checkouts" USING btree ("repository_id");--> statement-breakpoint
CREATE INDEX "repository_checkouts_workspace_id_idx" ON "repository_checkouts" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "team_repo_defaults_team_repository_unique" ON "team_repo_defaults" USING btree ("team_id","repository_id");--> statement-breakpoint
CREATE UNIQUE INDEX "team_repo_defaults_team_primary_unique" ON "team_repo_defaults" USING btree ("team_id") WHERE "team_repo_defaults"."is_primary" = true;--> statement-breakpoint
CREATE INDEX "team_repo_defaults_repository_idx" ON "team_repo_defaults" USING btree ("repository_id");--> statement-breakpoint
CREATE INDEX "team_repo_defaults_workspace_id_idx" ON "team_repo_defaults" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "project_teams_project_team_unique" ON "project_teams" USING btree ("project_id","team_id");--> statement-breakpoint
CREATE INDEX "project_teams_team_id_idx" ON "project_teams" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "project_teams_workspace_id_idx" ON "project_teams" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "team_cycles_remote_unique" ON "team_cycles" USING btree ("team_id","remote_cycle_id") WHERE "team_cycles"."remote_cycle_id" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "team_cycles_team_id_idx" ON "team_cycles" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "team_cycles_workspace_id_idx" ON "team_cycles" USING btree ("workspace_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "team_workflow_states_remote_unique" ON "team_workflow_states" USING btree ("team_id","remote_state_id") WHERE "team_workflow_states"."remote_state_id" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "team_workflow_states_team_category_idx" ON "team_workflow_states" USING btree ("team_id","category");--> statement-breakpoint
CREATE INDEX "team_workflow_states_workspace_id_idx" ON "team_workflow_states" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "teams_workspace_key_unique" ON "teams" USING btree ("workspace_id","key");--> statement-breakpoint
CREATE UNIQUE INDEX "teams_workspace_default_unique" ON "teams" USING btree ("workspace_id") WHERE "teams"."is_default" = true;--> statement-breakpoint
CREATE INDEX "teams_workspace_id_idx" ON "teams" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "teams_workspace_visibility_idx" ON "teams" USING btree ("workspace_id","visibility");--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_coordinator_agent_id_agents_id_fk" FOREIGN KEY ("coordinator_agent_id") REFERENCES "public"."agents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "linear_issue_links_linear_team_idx" ON "linear_issue_links" USING btree ("workspace_id","linear_team_id");--> statement-breakpoint
CREATE INDEX "task_domain_events_team_revision_idx" ON "task_domain_events" USING btree ("workspace_id","team_id","revision");--> statement-breakpoint
CREATE INDEX "tasks_team_id_status_idx" ON "tasks" USING btree ("team_id","status");--> statement-breakpoint
CREATE INDEX "tasks_workflow_state_ref_idx" ON "tasks" USING btree ("workflow_state_ref_id");--> statement-breakpoint
CREATE INDEX "tasks_cycle_ref_idx" ON "tasks" USING btree ("cycle_ref_id");