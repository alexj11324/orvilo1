export default {
  ...
  'agent_run_completed_title': 'Agent issue completed',
  ...
  'category.schedule': 'Scheduled issues',
  ...
  'inbox.priorityBanner.title': 'Important notifications now go to your priority inbox',
  'inbox.priorityBanner.keep': 'Keep priority inbox',
  'inbox.priorityBanner.disable': 'Disable',
  'inbox.addFilter': 'Add filter',
  'inbox.all': 'All notifications',
  'inbox.allStatus': 'All',
  'inbox.approve': 'Approve',
  'inbox.archive': 'Archive',
  'inbox.archiveAll': 'Archive all',
  'inbox.cancel': 'Withdraw',
  ...
  'inbox.notificationActions': 'Notification actions',
  'inbox.open': 'Open',
  ...
  'inbox.snooze': 'Snooze',
  'inbox.snoozePreset.hour': 'In 1 hour',
  'inbox.snoozePreset.laterToday': 'Later today (6 PM)',
  'inbox.snoozePreset.nextWeek': 'Next week (Mon 9 AM)',
  'inbox.snoozePreset.tomorrow': 'Tomorrow (9 AM)',
  'inbox.source.acpInput': 'Agent needs more information',
  'inbox.source.acpIntervention': 'Agent needs your review',
  'inbox.source.acpPermission': 'Approval required',
  'inbox.source.resourceTransfer': 'Resource transfer request',
  'inbox.source.resourceTransferOutgoing': 'Outgoing resource transfer',
  'inbox.source.taskReview': 'Review required',
  'inbox.source.workspaceOwnershipTransfer': 'Workspace ownership transfer request',
  'inbox.source.workspaceOwnershipTransferOutgoing': 'Outgoing ownership transfer',
  'inbox.sourceUnavailable':
    'Some inbox sources could not be loaded. Remaining cards are still current — this is not an empty inbox.',
