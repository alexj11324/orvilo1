...
description: >-
  Explore the Orvilo development setup, technology stack, and contribution
  guidelines.
tags:
  - Orvilo
  - Next.js
...
Welcome to the Orvilo Technical Development Getting Started Guide. Orvilo is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of Orvilo and how to configure and use these technologies in your development environment.
...
- **Component Library**: [Ant Design (antd)](https://ant.design/) as the base component library, [@lobehub/ui](https://www.npmjs.com/package/@lobehub/ui) as the business component library.
...
Orvilo uses a Monorepo architecture
(`@orvilo/` namespace).
...
├── packages/              # Shared packages (@orvilo/*)
...
Orvilo uses `react-i18next` for multilingual support,
...
During development, you only need to edit keys
...
To support developers in better understanding and using the technology stack of Orvilo, we provide a comprehensive list of resources and references — [Orvilo Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Orvilo GitHub Discussions](https://github.com/alexj11324/orvilo1/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
