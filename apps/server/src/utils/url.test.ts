...
describe('getCanonicalUrl', () => {
  ...
  it('should return correct URL for production environment', async () => {
    ...
    expect(result).toBe('https://orvilo.aspectlylabs.com/path/to/page');
    expect(urlJoin).toHaveBeenCalledWith('https://orvilo.aspectlylabs.com', 'path', 'to', 'page');
  });
  ...
  it('should work correctly without additional path arguments', async () => {
    ...
    expect(result).toBe('https://orvilo.aspectlylabs.com');
    expect(urlJoin).toHaveBeenCalledWith('https://orvilo.aspectlylabs.com');
  });
});
