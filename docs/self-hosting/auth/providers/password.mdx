---
title: Configuring Email/Password Authentication for Orvilo
description: >-
  Learn how to configure email and password authentication for Orvilo,
...
Orvilo supports traditional email and password authentication out of the box.
