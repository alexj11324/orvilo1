---
title: Configuring WeChat Authentication for Orvilo
description: >-
  Learn how to configure WeChat SSO for Orvilo, including creating an
...
<Callout type={'warning'}>
  ...
  approved website application. This process requires business verification
  China.
</Callout>
