/**
 * Orvilo Web Browsing Executor
 *
 * Handles web search and page crawling tool calls.
 */
import { WebBrowsingApiName, WebBrowsingManifest } from '@orvilo/builtin-tool-web-browsing';
import {
  type WebBrowsingDocumentService,
  WebBrowsingExecutionRuntime,
} from '@orvilo/builtin-tool-web-browsing/executionRuntime';
import {
...
import { BaseExecutor, SEARCH_SEARXNG_NOT_CONFIG } from '@orvilo/types';
