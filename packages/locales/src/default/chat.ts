export default {
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through Orvilo's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'taskDetail.prerequisites.input': 'Prerequisite task identifier',
  ...
  'taskDetail.changePriorityPlaceholder': 'Change priority…',
  'taskDetail.changeStatusPlaceholder': 'Change status…',
  'taskDetail.showingAllItems': 'Showing all items',
  'taskDetail.showingItems_one': 'Showing {{count}} item',
  'taskDetail.showingItems_other': 'Showing {{count}} items',
  ...
  'taskList.contextMenu.assignee': 'Assignee',
  'taskList.contextMenu.copy': 'Copy',
