...
连接官方 [Meta Model API](https://dev.meta.ai/)。

### `META_API_KEY`

- 类型：部署时可选；提供共享服务端密钥时必填。
...
- 类型：必选
- 描述：Google Cloud 服务账号密钥的 JSON 字符串。用于认证和授权访问 Vertex AI 服务，获取方法请参考 [Vertex AI 文档](https://cloud.google.com/vertex-ai/docs/start/authentication)
- 默认值：-
