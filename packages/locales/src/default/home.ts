export default {
  ...
  'brief.title': 'Brief',
  'brief.viewAllTasks': 'View all issues',
  ...
  'dashboard.customize.group.task': 'Issues',
  ...
  'dashboard.customize.tasks.count.title': 'Recent issues',
  ...
  'dashboard.customize.widget.tasks': 'Recent issues',
  ...
  'dashboard.mode.task': 'Issue',
  'dashboard.modeDesc.task': 'Create an issue, start it now, and track its progress',
  'dashboard.placeholder.chat': 'Ask, create, or start an issue',
  'dashboard.placeholder.task': 'Describe an issue to start right away',
  ...
  'dashboard.task.empty': 'No issues yet',
  'dashboard.task.title': 'Recent issues',
  'dashboard.task.viewAll': 'View all',
  'dashboard.task.unsupportedContext':
    'Issue mode does not support attachments or selected context yet. Remove them or switch to Agent mode; your draft has been kept.',
  ...
  'inbox.running.title': '{{count}} issue running',
  'inbox.running.title_plural': '{{count}} issues running',
  ...
  'recommendations.heteroAgent.description':
    'Detected the {{name}} CLI on this device — add {{name}} agent to chat with it from Orvilo.',
