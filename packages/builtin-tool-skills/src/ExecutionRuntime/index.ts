...
import { formatCommandResult, formatSandboxRecreation, resourcesTreePrompt } from '@orvilo/prompts';
import type {
...
export class SkillsExecutionRuntime {
  ...
  /**
   * Format command result using the shared formatCommandResult from @orvilo/prompts.
