...
import { invalidateLoginShellPathCache } from '@orvilo/heterogeneous-agents/resolveCliCommand';
...
export class BinaryManager {
   ...
   * so it satisfies the `ToolDetector` contract in `@orvilo/local-file-shell`
