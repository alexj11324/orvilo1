...
import { type Attributes, type Span } from '@orvilo/observability-otel/api';
import { context, diag, SpanKind, SpanStatusCode, trace } from '@orvilo/observability-otel/api';
import {
  ATTR_ERROR_TYPE,
...
} from '@orvilo/observability-otel/trpc';
