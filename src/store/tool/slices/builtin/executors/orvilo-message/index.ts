/**
 * Orvilo Message Executor — frontend entry.
 *
 * Composes the shared `MessageExecutor` + `MessageExecutionRuntime` from
 * `@orvilo/builtin-tool-message` with TRPC-backed adapters so the
...
import { MessageExecutor } from '@orvilo/builtin-tool-message/executor';
