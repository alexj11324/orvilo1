...
export const getFileConfig = () => {
  ...
  return createEnv({
    ...
    runtimeEnv: {
      ...
      S3_PRESIGN_ENDPOINT: process.env.S3_PRESIGN_ENDPOINT,
    ...
    server: {
      ...
      // Client-reachable S3 API endpoint used only for signing presigned URLs.
      // Distinct from S3_PUBLIC_DOMAIN, which is an object/CDN domain and may
      // not serve the S3 API at all.
