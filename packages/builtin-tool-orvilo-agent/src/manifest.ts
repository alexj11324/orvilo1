...
export const OrviloAgentManifest: BuiltinToolManifest = {
  api: [
    {
      description:
    ...
    // ==================== Planning ====================
    {
      ...
      name: OrviloAgentApiName.createPlan,
    ...
    },
    {
      ...
      name: OrviloAgentApiName.updatePlan,
      parameters: {
        properties: {
          planId: {
            description:
    ...
    // ==================== Quick Todo ====================
    {
      ...
      name: OrviloAgentApiName.createTodos,
      humanIntervention: 'required',
      parameters: {
        properties: {
          adds: {
...
- "processing": requires "index" only (marks item as in progress)`,
      name: OrviloAgentApiName.updateTodos,
      renderDisplayControl: 'expand',
      parameters: {
        properties: {
          operations: {
    ...
    },
    {
      ...
      name: OrviloAgentApiName.clearTodos,
      humanIntervention: 'required',
      renderDisplayControl: 'expand',
      parameters: {
        properties: {
    ...
    // ==================== Ask User Question ====================
    {
      ...
      name: OrviloAgentApiName.askUserQuestion,
  ...
  meta: {
    ...
    readme: 'Orvilo Agent provides built-in assistant capabilities that can be expanded over time.',
    title: 'Orvilo Agent',
  },
