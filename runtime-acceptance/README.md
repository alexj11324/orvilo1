...
| `pd8-issue-rows/`             | ✅ 在盘                                                                                                                               | `302a674e6`                                                        | Project Issues 行结构 + My/Team Issues 对照   | 4 PNG + 3 探针脚本：行首 `[status @275][ID @299]`、workflow chip 7→0、status 下拉实弹、右键 Priority ▸ 可达、My Issues 18 chips / Team board 7 chips 不变                                                                                                                                                                                                                                                                                                                                                                                                            |
