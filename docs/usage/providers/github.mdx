---
title: Using GitHub Models in Orvilo
description: >-
  Learn how to configure and use GitHub's API Key in Orvilo to start
...
This guide will walk you through how to use GitHub Models within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in Orvilo
...
And that’s it! You’re now ready to start using GitHub-provided models in Orvilo for conversations and interactions.
