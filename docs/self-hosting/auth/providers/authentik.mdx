---
title: Configuring Authentik Authentication for Orvilo
description: >-
  Learn how to configure Authentik SSO for Orvilo, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for Orvilo. Use `authentik` for Authentik                        |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use Orvilo.
</Callout>
