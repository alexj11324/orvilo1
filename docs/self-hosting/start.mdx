---
title: Build Your Own Orvilo - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy Orvilo. Choose the platform that best suits your needs.
tags:
  - Orvilo
  - Deployment Platform
  - Vercel
...
# Build Your Own Orvilo

Orvilo can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, Orvilo supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

Orvilo consists of several key components:
...
Before deploying Orvilo, gather the following:
...
5. **Regular updates** — Keep Orvilo and dependencies up to date
