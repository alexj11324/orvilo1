export default {
  ...
  'heteroImport.badge.linked': 'From Orvilo',
  'heteroImport.badge.linkedTip':
    'This session was started from Orvilo and already lives in your topic list',
  ...
  'heteroImport.error.desc':
    'Could not read the local sessions. Check that Orvilo can access your transcripts, then retry.',
  ...
  'moveModal.back': 'Back',
  'moveModal.confirmContent_one': 'Move {{count}} topic to “{{title}}”?',
  'moveModal.confirmContent_other': 'Move {{count}} topics to “{{title}}”?',
  'moveModal.confirmOk': 'Move',
  'moveModal.done_one': '{{count}} topic moved',
  'moveModal.done_other': '{{count}} topics moved',
  'moveModal.doneOk': 'Done',
  'moveModal.empty': 'No other agents',
  'moveModal.error': 'Move failed, please try again',
  'moveModal.goToTarget': 'Go to “{{title}}”',
  'moveModal.moving': 'Moving…',
  'moveModal.searchPlaceholder': 'Search agents…',
  'moveModal.title': 'Move topics',
  'newTopic': 'New Topic',
