export default {
  ...
  'navigation.projectMilestones': 'Project milestones',
  ...
  'navigation.task': 'Issue',
  'navigation.tasks': 'Issues',
  ...
  'remoteServer.configDesc': 'Connect to the remote Orvilo server to enable data synchronization',
  ...
  'sync.orviloCloud.description': 'Officially provided cloud version',
  'sync.orviloCloud.title': 'Orvilo Cloud',
