/**
 * Tests for Orvilo Tools Executor (activateTools discovery allowlist)
 */
...
// Import after mocks
const { activatorExecutor } = await import('../orvilo-activator');
...
describe('orvilo-activator executor discovery allowlist', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
