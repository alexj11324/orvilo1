---
title: Using ComfyUI in Orvilo for Image Generation
description: >-
  Learn how to configure and use the ComfyUI service in Orvilo to support
...
# Using ComfyUI in Orvilo

<Image alt={'Using ComfyUI in Orvilo'} cover src={'https://hub-apac-1.objects.aspectlylabs.com/docs/e9b811f248a1db2bd1be1af888cf9b9d.png'} />

This guide will walk you through how to use [ComfyUI](https://github.com/comfyanonymous/ComfyUI) in Orvilo for high-quality AI image generation and editing.

## Introduction to ComfyUI

ComfyUI is a powerful GUI for Stable Diffusion and Flow Diffusion, offering a node-based workflow interface. Orvilo integrates ComfyUI with full support for the FLUX model series, enabling both text-to-image generation and image editing.
...
### Step 1: Configure ComfyUI in Orvilo

#### 1. Open Settings

- Go to the `Settings` panel in Orvilo
