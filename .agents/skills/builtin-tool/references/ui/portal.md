...
```tsx
import type { BuiltinPortalProps, CrawlPluginState, SearchQuery } from '@orvilo/types';
...
```ts
import { WebBrowsingManifest, WebBrowsingPortal } from '@orvilo/builtin-tool-web-browsing/client';
import { type BuiltinPortal } from '@orvilo/types';
