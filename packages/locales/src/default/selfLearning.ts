export default {
  ...
  'rules.detail.revision': 'v{{revision}}',
  'rules.detail.status.active': 'In use',
  'rules.detail.status.rejected': 'Rejected',
  'rules.detail.status.retired': 'Retired',
  'rules.detail.updatedAt': 'updated {{time}}',
