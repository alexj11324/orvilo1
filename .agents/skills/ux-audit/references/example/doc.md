...
(`/agent/:aid/docs/:docId` → `src/routes/(main)/agent/docs`), 2026-07 (ORVILO-11214, under the
Chat UX Audit surface ORVILO-11145). Use it as a **template for the output shape**, not as
