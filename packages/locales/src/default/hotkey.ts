export default {
  ...
  'createTask.desc': 'Open the create issue modal',
  'createTask.title': 'Create Issue',
  ...
  'goToDrafts.desc': 'Press G then D to open your drafts',
  'goToDrafts.title': 'Go to Drafts',
  'goToInbox.desc': 'Press G then I to open the inbox',
  'goToInbox.title': 'Go to Inbox',
  'goToMyIssues.desc': 'Press G then M to open my issues',
  'goToMyIssues.title': 'Go to My Issues',
  'goToProjects.desc': 'Press G then P to open projects',
  'goToProjects.title': 'Go to Projects',
  'goToReviews.desc': 'Press G then R to open your review queue',
  'goToReviews.title': 'Go to Reviews',
  'goToViews.desc': 'Press G then V to open saved views',
  'goToViews.title': 'Go to Views',
  'navigateToChat.desc': 'Switch to the Chat tab and enter Orvilo AI',
