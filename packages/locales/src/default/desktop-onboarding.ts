export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Orvilo. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Orvilo',
  ...
  'screen5.actions.signInCloud': 'Sign in to Orvilo Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Orvilo Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Orvilo Cloud',
