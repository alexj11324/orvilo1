---
title: Using Tencent Hunyuan in Orvilo
description: >-
  Learn how to configure and use Tencent Hunyuan's API Key in Orvilo to start
...
# Using Tencent Hunyuan in Orvilo
...
This guide will walk you through how to use Tencent Hunyuan in Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure Tencent Hunyuan in Orvilo
...
And that’s it! You’re now ready to use Tencent Hunyuan’s models for conversations in Orvilo.
