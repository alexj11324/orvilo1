---
title: Using LM Studio in Orvilo
description: >-
...
# Using LM Studio in Orvilo

<Image alt={'Using LM Studio in Orvilo'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
This guide will walk you through how to use LM Studio within Orvilo:
...
<Steps>
  ...
  ### Step 5: Connect LM Studio to Orvilo
...
And that’s it! You’re now ready to use models running in LM Studio directly within Orvilo.
