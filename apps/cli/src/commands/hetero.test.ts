...
import { HETEROGENEOUS_AGENT_CONFIGS } from '@orvilo/heterogeneous-agents';
import { HETERO_EXEC_INHERIT_PROCESS_GROUP_ENV } from '@orvilo/heterogeneous-agents/protocol';
import type * as HeteroSpawn from '@orvilo/heterogeneous-agents/spawn';
...
vi.mock('@orvilo/heterogeneous-agents/resolveCliCommand', () => ({
