...
description: >-
  Step-by-step guide to configure Upstash Redis for Orvilo cache and session
  storage.
tags:
  - Upstash
  - Redis
...
[Upstash](https://upstash.com/) is a serverless Redis service that provides a free tier and pay-as-you-go pricing, making it ideal for Orvilo deployments.
...
<Steps>
  ...
  <Image alt={'Copy Redis URL from Upstash'} src={'https://hub-apac-1.objects.aspectlylabs.com/docs/43d110283ba816c0c2b45408e4f9d344.png'} />
  ...
  <Callout type={'info'}>
    Upstash uses `rediss://` (with double 's') for TLS connections. Orvilo supports this format automatically.
  </Callout>
</Steps>
