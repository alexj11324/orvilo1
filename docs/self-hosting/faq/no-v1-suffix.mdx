---
title: Troubleshooting `OPENAI_PROXY_URL` in Orvilo Configuration for Empty Response
description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response
  after configuring the Orvilo `OPENAI_PROXY_URL` environment variable.
tags:
  - OPENAI_PROXY_URL
...
- Why is the return value blank after configuring environment variables in Docker?
- Reasons for errors when using third-party interfaces
- No response when the proxy server address is filled in for chat
