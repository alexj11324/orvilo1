---
title: Configuring Generic OIDC Authentication for Orvilo
description: >-
  Learn how to configure any OpenID Connect provider for Orvilo using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate Orvilo with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
