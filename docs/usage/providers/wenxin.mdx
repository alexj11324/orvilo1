---
title: Using Wenxin Qianfan in Orvilo
description: >-
  Learn how to configure and use the Wenxin Qianfan API Key in Orvilo to start
...
# Using Wenxin Qianfan in Orvilo
...
This guide will walk you through how to use Wenxin Qianfan in Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in Orvilo
...
Now you're all set to start using Wenxin Qianfan models for conversations in Orvilo.
