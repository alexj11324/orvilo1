...
describe('useChatInputNotice', () => {
  ...
  it('treats a disabled model as unavailable — enable remediation is retired', () => {
    // The model still exists in the catalog but is absent from the enabled
    // chat list; the notice is informational only (pick another model).
    testState.aiInfra.isInitAiProviderRuntimeState = true;
