...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with Orvilo:
    ...
    Built-in skills are maintained by the Orvilo team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the Orvilo marketplace:
...
Orvilo includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the Orvilo marketplace:
...
MCP is Orvilo's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
