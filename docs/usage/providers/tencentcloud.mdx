---
title: Using Tencent Cloud API Key in Orvilo
description: >-
  Learn how to configure and use Tencent Cloud AI models in Orvilo, obtain your
...
# Using Tencent Cloud in Orvilo

<Image alt={'Using Tencent Cloud in Orvilo'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into Orvilo:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Orvilo

  - Open Orvilo and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in Orvilo for conversations.
