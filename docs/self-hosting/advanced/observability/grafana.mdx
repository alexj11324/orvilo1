...
description: >-
  Monitor and analyze your Orvilo instance using Grafana dashboards, Prometheus
...
Orvilo supports advanced observability for self-hosted deployments using open-source tools:
...
This guide will help you set up and use these tools to monitor your Orvilo instance.
...
```bash
curl -O https://raw.githubusercontent.com/alexj11324/orvilo1/HEAD/docker-compose/production/grafana/docker-compose.yml
curl -O https://raw.githubusercontent.com/alexj11324/orvilo1/HEAD/docker-compose/production/grafana/.env.example
mv .env.example .env
```
...
2. Start the stack with the correct profile:
   ...
   This will launch Grafana, Prometheus, Tempo, and the otel-collector alongside Orvilo with Casdoor, Minio, and other advanced services.
...
- Verify Prometheus and Tempo are scraping and receiving data from Orvilo and otel-collector.

## See Also

- [Langfuse Observability](https://orvilo.aspectlylabs.com/docs/self-hosting/advanced/observability/langfuse)
- [Self-Hosting Overview](https://orvilo.aspectlylabs.com/docs/self-hosting/start)
