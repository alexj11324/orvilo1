export default {
  'taskDetail.prerequisites.title': 'Prerequisites',
  'taskDetail.prerequisites.add': 'Add prerequisite',
  'taskDetail.prerequisites.remove': 'Remove prerequisite {{task}}',
  'taskDetail.prerequisites.blocked': 'Blocked until all prerequisite tasks are completed.',
  'taskDetail.prerequisites.satisfied': 'All prerequisites are completed.',
  'taskDetail.prerequisites.empty': 'No prerequisite tasks.',
  'taskDetail.prerequisites.locked': 'Pause or reopen this task to add prerequisites.',
  'taskDetail.prerequisites.unavailable': 'Unavailable prerequisite',
  'taskDetail.prerequisites.saveError': 'Could not save the prerequisite. Please retry.',
  'taskDetail.prerequisites.search': 'Search by task ID or title',
  'taskDetail.prerequisites.loading': 'Loading tasks…',
  'taskDetail.prerequisites.loadError': 'Could not load tasks.',
  'taskDetail.prerequisites.retry': 'Retry',
  'taskDetail.prerequisites.noResults': 'No matching tasks in this project.',
  'taskDetail.prerequisites.more': 'Type a more specific ID or title to find more tasks.',
