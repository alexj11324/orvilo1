---
title: Using Nvidia NIM API Key in Orvilo
description: >-
  Learn how to configure and use Nvidia NIM AI models in Orvilo, obtain your
...
# Using Nvidia NIM in Orvilo

<Image alt={'Using Nvidia NIM in Orvilo'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in Orvilo:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Orvilo

  - Go to the `App Settings` section in Orvilo and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in Orvilo for your conversations.
