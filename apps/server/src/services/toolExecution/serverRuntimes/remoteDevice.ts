import { type DeviceAttachment, RemoteDeviceIdentifier } from '@orvilo/builtin-tool-remote-device';
import { RemoteDeviceExecutionRuntime } from '@orvilo/builtin-tool-remote-device/executionRuntime';
