...
Use the official [Meta Model API](https://dev.meta.ai/). See [Using Meta in Orvilo](/docs/usage/providers/meta) for setup instructions.
...
Connect to your own Unsloth Studio instance. See [Using Unsloth in Orvilo](/docs/usage/providers/unsloth) for browser authentication and desktop CORS limitations.
