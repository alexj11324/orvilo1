...
import type { OrviloAgentChatConfig, OrviloAgentConfig } from '@orvilo/types';
...
export const createGraphAwareAgentFactory =
  ...
  (config) => {
    ...
    const runtimeAgentConfig = config.agentConfig as OrviloAgentConfig | undefined;
    ...
    const legacyChatConfig = runtimeAgentConfig?.chatConfig as
      (OrviloAgentChatConfig & { enableGraphMode?: boolean; graph?: unknown }) | undefined;
