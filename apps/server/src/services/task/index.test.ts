...
vi.mock('@/database/models/agentOperation', () => ({
  AgentOperationModel: vi.fn().mockImplementation(function () {
    return { findById: operationFindByIdMock };
  }),
}));
...
vi.mock('@/database/models/message', () => ({
  MessageModel: vi.fn().mockImplementation(function () {
    return {
      ...
      getLatestNonToolMessageId: latestNonToolMock,
      getLatestSpineMessageId: latestSpineMock,
    };
  }),
}));
...
vi.mock('@/server/services/taskRunner', () => ({
  TaskRunnerService: vi.fn().mockImplementation(function () {
    return {
      cascadeOnCompletion: cascadeMock,
