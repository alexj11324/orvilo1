export default {
  ...
  'betterAuth.signup.cardTitle': 'Create your {{appName}} Account',
  ...
  'profile.usernameDescription': 'One word, like a nickname or first name',
  'profile.jobTitle': 'Title',
  'profile.jobTitleDescription': 'Your job title or role',
  'profile.jobTitlePlaceholder': 'Software engineer',
  ...
  'stats.heatmapStats.longestTask': 'Longest Issue',
