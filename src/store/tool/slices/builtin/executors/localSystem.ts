import type { RunCommandState } from '@orvilo/builtin-tool-local-system';
import { localSystemExecutor } from '@orvilo/builtin-tool-local-system/client/executor';
import type { ToolAfterCallContext } from '@orvilo/types';
