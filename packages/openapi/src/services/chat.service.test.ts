...
//
// Mocked on `@orvilo/business-const`, which is where they are declared —
...
vi.mock('@orvilo/model-runtime', () => ({ mergeModelRuntimeHooks: vi.fn() }));
vi.mock('@orvilo/types', () => ({ RequestTrigger: { Api: 'api' } }));
