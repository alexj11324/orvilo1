...
description: >-
  Step-by-step guide to set up Orvilo development environment locally or
  online.
tags:
  - Orvilo
  - Development Setup
...
Welcome to the Orvilo development environment setup guide.
...
Before starting development on Orvilo, you need to install and configure some necessary software and tools in your local environment. This document will guide you through these steps.

### Development Environment Requirements

First, you need to install the following software:

- Node.js: Orvilo is built on Node.js, so you need to install Node.js. We recommend installing the latest stable version.
...
After installing the above software, you can start setting up the Orvilo project.

#### 1. Get the Code

First, you need to clone the Orvilo codebase from GitHub. Run the following command in the terminal:
...
Launch the Orvilo development server:

```bash
bun run dev
```

Now, you can open `http://localhost:3010` in your browser, and you should see the welcome page of Orvilo. This indicates that you have successfully set up the development environment.
...
- **PostgreSQL**: `postgres://postgres@localhost:5432/orvilo`
...
During the development process, if you encounter any issues with environment setup or have any questions about Orvilo development, feel free to ask us at any time. We look forward to seeing your contributions!

[codespaces-link]: https://codespaces.new/alexj11324/orvilo1
