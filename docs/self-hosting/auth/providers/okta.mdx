---
title: Configuring Okta Authentication for Orvilo
description: >-
  Learn how to configure Okta SSO for Orvilo, including creating an application
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for Orvilo. Use `okta` for Okta                                  |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use Orvilo.
</Callout>
