---
title: Using Azure AI API Key in Orvilo
description: >-
  Learn how to configure and use Azure AI models in Orvilo, obtain your API
...
# Using Azure AI in Orvilo

<Image alt={'Using Azure AI in Orvilo'} cover src={'/blog/assets29de82efbe7657a8b9ba7daf0904585d.webp'} />
...
This guide will walk you through how to integrate Azure AI models into Orvilo:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in Orvilo
...
That's it! You're now ready to use Azure AI models for conversations in Orvilo.
