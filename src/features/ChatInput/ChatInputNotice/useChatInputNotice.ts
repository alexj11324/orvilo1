...
export const resolveChatInputNotice = ({
  ...
  if (
    ...
    // Provider/model management is retired — a stale selection is informational
    // only; the remedy is picking another model.
    return { key: 'input.modelUnavailable', type: 'warning' } as const;
  }
