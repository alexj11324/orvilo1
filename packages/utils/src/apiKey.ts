import * as businessConst from '@orvilo/business-const';

/**
 * A distribution's `@orvilo/business-const` override replaces the whole
...
export const API_KEY_PREFIX =
  typeof configuredApiKeyPrefix === 'string' ? configuredApiKeyPrefix : 'sk-ov-';
