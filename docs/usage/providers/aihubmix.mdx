...
description: Learn how to configure and use the AIHubMix provider in Orvilo
tags:
  - AIHubMix
...
AIHubMix is an AI model aggregation platform that offers access to a variety of AI models through a unified OpenAI-compatible API. This guide will help you set up the AIHubMix provider in Orvilo.
...
1. **Create an AIHubMix Account**
   - Visit [AIHubMix](https://aihubmix.com)
   - Sign up for an account

2. **Obtain an API Key**
   - Log in to your AIHubMix dashboard
   - Navigate to the API settings
   - Generate an API key for use with Orvilo
...
1. **Configure the API Key**
   ...
   - Restart your Orvilo instance

2. **Select a Model**
   - Go to Orvilo settings
