...
export const appStorageDir = path.join(userDataDir, 'orvilo-storage');

// Legacy local database directory used in older desktop versions
export const legacyLocalDbDir = path.join(appStorageDir, 'orvilo-local-db');
...
export const LOCAL_STORAGE_URL_PREFIX = '/orvilo-desktop-file';
