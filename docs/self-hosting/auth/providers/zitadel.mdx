---
title: Configuring ZITADEL Authentication for Orvilo
description: >-
  Learn how to configure ZITADEL SSO for Orvilo, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for Orvilo. Use `zitadel` for ZITADEL                            |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use Orvilo.
</Callout>
