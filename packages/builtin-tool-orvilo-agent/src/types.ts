export const OrviloAgentIdentifier = 'orvilo-agent';

export const OrviloAgentApiName = {
...
export type OrviloAgentApiNameType = (typeof OrviloAgentApiName)[keyof typeof OrviloAgentApiName];
...
// now). Re-exported here so orvilo-agent consumers get the argument types from a
// single import surface while both tools coexist.
export type {
  AskUserQuestionArgs,
  AskUserQuestionItem,
  AskUserQuestionOption,
} from '@orvilo/builtin-tool-user-interaction';
