---
title: Configuring Apple Authentication for Orvilo
description: >-
  Learn how to configure Apple Sign In for Orvilo, including creating
...
<Steps>
  ...
  5. Fill in:
     - **Description**: e.g., `Orvilo`
     - **Bundle ID**: e.g., `com.yourcompany.orvilo`
  ...
  3. Fill in:
     - **Description**: e.g., `Orvilo Web`
     - **Identifier**: e.g., `com.yourcompany.orvilo.web` (this is your Client ID)
