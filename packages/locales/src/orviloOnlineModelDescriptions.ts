/**
 * Orvilo provider-scoped model description defaults (`orvilo.${id}.description`).
 *
 * Sourced from Orvilo online model config. Prefer updating that source over hand-editing.
 * Cloud monorepo regenerates this file via
 * `orvilo-cloud/.agents/skills/add-model/scripts/sync-orvilo-model-locales.ts`.
 *
 * Consumed by both `default/models.ts` (Node) and `default/models.vite.ts` (Vite SPA).
 */
export const orviloHubOnlineModelDescriptions = {
  'orvilo.claude-fable-5-1.description':
  ...
  'orvilo.claude-fable-5.description':
  ...
  'orvilo.claude-opus-5.description':
  ...
  'orvilo.dreamina-seedance-2-0-260128.description':
  ...
  'orvilo.dreamina-seedance-2-0-fast-260128.description':
  ...
  'orvilo.fal-ai/bytedance/seedream/v4.5.description':
  ...
  'orvilo.fal-ai/bytedance/seedream/v4.description':
  ...
  'orvilo.fal-ai/hunyuan-image/v3.description':
    'A powerful native multimodal image generation model.',
  'orvilo.fal-ai/qwen-image-edit.description':
  ...
  'orvilo.gemini-2.5-flash-image.description':
    "Nano Banana is Google's newest, fastest, and most efficient native multimodal model, enabling conversational image generation and editing.",
  ...
  'orvilo.gemini-3-pro-image-preview.description':
    "Gemini 3 Pro Image (Nano Banana Pro) is Google's image generation model and also supports multimodal chat.",
  ...
  'orvilo.gemini-3.1-flash-image.description':
    'Gemini 3.1 Flash Image (Nano Banana 2) delivers Pro-level image quality at Flash speed with multimodal chat support.',
  'orvilo.gemini-3.1-flash-lite-image:image.description':
  ...
  'orvilo.gemini-3.1-flash-lite-image.description':
    "Gemini 3.1 Flash Lite Image (Nano Banana 2 Lite) is Google's fastest and most cost-efficient image generation model, built for high-volume generation and editing.",
  'orvilo.gemini-3.1-pro-preview.description':
    'Gemini 3.1 Pro Preview improves on Gemini 3 Pro with stronger reasoning for complex tasks.',
  'orvilo.gemini-3.5-flash-lite.description':
  ...
  'orvilo.gemini-3.8-flash.description':
  ...
  'orvilo.gpt-5.6-terra.description':
  ...
  'orvilo.grok-4.20-beta-0309-non-reasoning.description':
    'A non-reasoning variant for simple use cases',
  'orvilo.grok-4.20-beta-0309-reasoning.description':
    'Intelligent, blazing-fast model that reasons before responding',
  'orvilo.grok-4.3.description': 'The most truth-seeking large language model in the world',
  'orvilo.grok-4.5.description':
  ...
  'orvilo.imagen-4.0-fast-generate-001.description':
    'Imagen 4th generation text-to-image model series',
  'orvilo.imagen-4.0-generate-001.description': 'Imagen 4th generation text-to-image model series',
  'orvilo.imagen-4.0-ultra-generate-001.description':
    'Imagen 4th generation text-to-image model series Ultra version',
  'orvilo.kimi-k2.5.description':
    'Kimi K2.5 is a versatile multimodal model for conversational and agent tasks across text and vision.',
  'orvilo.kimi-k2.6.description':
  ...
  'orvilo.kimi-k2.7-code.description':
  ...
  'orvilo.orvilo-glm-5.2-fast.description':
  ...
  'orvilo.orvilo-kimi-k3-fast.description':
  ...
  'orvilo.mimo-v2.5-pro.description':
  ...
  'orvilo.qwen3.7-plus.description':
  ...
  'orvilo.qwen3.8-max-0902.description':
  ...
  'orvilo.qwen3.8-max-preview.description':
  ...
  'orvilo.seedance-1-5-pro-251215.description':
  ...
  'orvilo.seedream-5-0-260128.description':
  ...
  'orvilo.text-embedding-3-small.description':
