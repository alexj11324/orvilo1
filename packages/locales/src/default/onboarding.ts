export default {
  ...
  'reui.action.continue': 'Continue',
  'reui.action.createWorkspace': 'Create workspace',
  'reui.action.openWorkspace': 'Open {{name}}',
  'reui.action.reviewSetup': 'Review setup',
  'reui.action.skip': 'Skip',
  'reui.action.setupSaved': 'Setup saved',
  'reui.action.setupComplete': 'Setup complete',
  'reui.action.back': 'Back',
  'reui.action.backAria': 'Back to previous step',
  'reui.error.complete': 'We could not finish setup. Check your connection and try again.',
  'reui.error.invites': 'Some invitations could not be sent. Review the addresses and try again.',
  'reui.goal.explore.description': 'Start with sample data and lighter setup.',
  'reui.goal.explore.label': 'Just exploring',
  'reui.goal.migration.description': 'Use familiar fields and migration defaults.',
  'reui.goal.migration.label': 'Replace our current tool',
  'reui.goal.projects.description': 'Give each team one source of truth.',
  'reui.goal.projects.label': 'Cross-functional projects',
  'reui.goal.roadmaps.description': 'Connect goals, projects, and releases.',
  'reui.goal.roadmaps.label': 'Product roadmaps',
  'reui.goal.sprints.description': 'Keep issues, cycles, and reviews moving.',
  ...
  'reui.invite.legend': 'Invite teammates',
  'reui.invite.role': 'Role',
  'reui.invite.roleLabel': 'Invitee {{number}} role',
  'reui.inviteRole.admin.description': 'Can manage workspace settings.',
  'reui.inviteRole.admin.label': 'Admin',
  'reui.inviteRole.guest.description': 'Can view invited projects.',
  'reui.inviteRole.guest.label': 'Guest',
  'reui.inviteRole.member.description': 'Can create and update work.',
  'reui.inviteRole.member.label': 'Member',
  'reui.photo.alt': 'Uploaded profile photo',
  'reui.photo.description': 'PNG or JPG, at least 400 x 400 px, up to 10 MB.',
  'reui.photo.replace': 'Replace photo',
  'reui.photo.upload': 'Upload photo',
  'reui.profile.fullName': 'Full name',
  'reui.profile.jobTitle': 'Job title',
  'reui.profile.legend': 'Profile details',
  'reui.profile.telemetryDescription': 'Allow anonymous usage data to improve Orvilo.',
  'reui.profile.telemetryLabel': 'Share anonymous product analytics',
  'reui.profile.timezone': 'Timezone',
  'reui.profile.timezoneEmpty': 'No timezones found.',
  'reui.profile.timezonePlaceholder': 'Select a timezone',
  'reui.role.developer.description': 'Track issues, reviews, and implementation.',
  'reui.role.developer.label': 'Developer',
  'reui.role.design.description': 'Shape specs, decisions, and handoff.',
  'reui.role.design.label': 'Designer',
  'reui.role.engineering.description': 'Coordinate cycles, dependencies, and reviews.',
  'reui.role.engineering.label': 'Engineering Manager',
  'reui.role.founder.description': 'Keep launches and priorities in view.',
  'reui.role.founder.label': 'Founder or Executive',
  'reui.role.operations.description': 'Standardize ownership and handoffs.',
  'reui.role.operations.label': 'Operations Manager',
  'reui.role.product.description': 'Plan roadmaps and align releases.',
  'reui.role.product.label': 'Product Manager',
  ...
  'reui.source.friend.label': 'Friend / coworker',
  'reui.source.google.description': 'Search or ads.',
  'reui.source.google.label': 'Google',
  'reui.source.instagram.description': 'A story, post, or creator share.',
  'reui.source.instagram.label': 'Instagram',
  'reui.source.linkedin.description': 'A professional post or share.',
  'reui.source.linkedin.label': 'LinkedIn',
  'reui.source.newsletter.description': 'An email roundup.',
  'reui.source.newsletter.label': 'Newsletter',
  'reui.source.other.description': 'Something else.',
  'reui.source.other.label': 'Other',
  'reui.source.outside.description': 'Conference, billboard, or offline mention.',
  'reui.source.outside.label': 'Billboard / outside',
  'reui.source.podcast.description': 'A show or interview.',
  'reui.source.podcast.label': 'Podcast',
  'reui.source.reddit.description': 'A thread, review, or recommendation.',
  'reui.source.reddit.label': 'Reddit',
  'reui.source.x.description': 'A post or discussion on X.',
  'reui.source.x.label': 'X.com',
  'reui.source.youtube.description': 'A demo, review, or walkthrough.',
  'reui.source.youtube.label': 'YouTube',
  'reui.source.fieldLabel': 'Where did you hear about Orvilo?',
  'reui.source.fieldPlaceholder': 'Type the source',
  'reui.source.groupLabel': 'How did you hear about us?',
  'reui.step.goals.description': 'Pick the workflows this workspace should support.',
  'reui.step.goals.label': 'Goals',
  'reui.step.goals.title': 'Choose your first goals',
  'reui.step.invite.description': 'Add the people who should join this workspace.',
  'reui.step.invite.label': 'Invite',
  'reui.step.invite.title': 'Invite teammates',
  'reui.step.profile.description': 'Add the details teammates will see across the workspace.',
  'reui.step.profile.label': 'Profile',
  'reui.step.profile.title': 'Set up your profile',
  'reui.step.role.description': 'Starter views will match your daily work.',
  'reui.step.role.label': 'Role',
  'reui.step.role.title': 'Choose your role',
  'reui.step.source.description':
    'Tell us where Orvilo first showed up for you. This step is optional.',
  'reui.step.source.label': 'Source',
  'reui.step.source.title': 'How did you hear about us?',
  'reui.step.workspace.description': 'Name the shared space your team will use first.',
  'reui.step.workspace.label': 'Workspace',
  'reui.step.workspace.title': 'Create your workspace',
  'reui.stepper.ariaLabel': 'Onboarding progress',
  'reui.stepper.ariaStep': 'Step {{step}}: {{label}}',
  'reui.stepper.counter': 'Step {{current}} of {{total}}',
  'reui.stepper.counterComplete': '{{total}} of {{total}}',
  'reui.stepper.profile': 'Basic profile details.',
  'reui.stepper.role': 'Tune starter views.',
  'reui.stepper.source': 'Optional discovery signal.',
  'reui.stepper.workspace': 'Name the workspace.',
  'reui.stepper.goals': 'Pick first workflows.',
  'reui.stepper.invite': 'Add teammates.',
  'reui.teamSize.company.description': 'Company.',
  'reui.teamSize.company.label': '501-1,000',
  'reui.teamSize.department.description': 'Department.',
  'reui.teamSize.department.label': '51-200',
  'reui.teamSize.enterprise.description': 'Enterprise.',
  'reui.teamSize.enterprise.label': '1,001-5,000',
  'reui.teamSize.global.description': 'Global organization.',
  'reui.teamSize.global.label': '5,000+',
  'reui.teamSize.midmarket.description': 'Mid-market team.',
  'reui.teamSize.midmarket.label': '201-500',
  'reui.teamSize.small.description': 'Small team.',
  'reui.teamSize.small.label': '2-10',
  'reui.teamSize.solo.description': 'Personal setup.',
  'reui.teamSize.solo.label': 'Just myself',
  'reui.teamSize.team.description': 'Growing team.',
  'reui.teamSize.team.label': '11-50',
  'reui.timezone.americas': 'Americas',
  'reui.timezone.asiaPacific': 'Asia/Pacific',
  'reui.timezone.amsterdam': '(GMT+1) Amsterdam',
  'reui.timezone.berlin': '(GMT+1) Berlin',
  'reui.timezone.chicago': '(GMT-6) Chicago',
  'reui.timezone.dubai': '(GMT+4) Dubai',
  'reui.timezone.europe': 'Europe',
  'reui.timezone.london': '(GMT+0) London',
  'reui.timezone.losAngeles': '(GMT-8) Los Angeles',
  'reui.timezone.madrid': '(GMT+1) Madrid',
  'reui.timezone.newYork': '(GMT-5) New York',
  'reui.timezone.paris': '(GMT+1) Paris',
  'reui.timezone.rome': '(GMT+1) Rome',
  'reui.timezone.saoPaulo': '(GMT-3) Sao Paulo',
  'reui.timezone.seoul': '(GMT+9) Seoul',
  'reui.timezone.shanghai': '(GMT+8) Shanghai',
  'reui.timezone.singapore': '(GMT+8) Singapore',
  'reui.timezone.sydney': '(GMT+11) Sydney',
  'reui.timezone.toronto': '(GMT-5) Toronto',
  'reui.timezone.tokyo': '(GMT+9) Tokyo',
  'reui.timezone.vancouver': '(GMT-8) Vancouver',
  'reui.workspace.legend': 'Workspace setup',
