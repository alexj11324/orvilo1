...
import { OrviloAgentApiName, VENT_CATEGORIES, VENT_SEVERITIES } from '../../types';
...
class OrviloAgentExecutor extends BaseExecutor<typeof OrviloAgentApiName> {
  readonly identifier = OrviloAgentManifest.identifier;
  protected readonly apiEnum = OrviloAgentApiName;
...
export const orviloAgentExecutor = new OrviloAgentExecutor();
