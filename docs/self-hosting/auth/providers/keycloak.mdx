---
title: Configuring Keycloak Authentication for Orvilo
description: >-
  Learn how to configure Keycloak SSO for Orvilo, including creating a client
...
<Steps>
  ...
  4. Configure the client:
     ...
     - **Client ID**: `orvilo` (or any name you prefer)
  5. Click **Next**
