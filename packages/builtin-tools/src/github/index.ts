import { GITHUB_TOOL_NAMES, GitHubInspector } from '@orvilo/shared-tool-ui/inspectors';
import { GitHubRender as SharedGitHubRender } from '@orvilo/shared-tool-ui/renders';
import { type BuiltinInspector, type BuiltinRender } from '@orvilo/types';
