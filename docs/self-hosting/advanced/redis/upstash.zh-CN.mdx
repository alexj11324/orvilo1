...
description: 详细指南：如何配置 Upstash Redis 用于 Orvilo 的缓存和会话存储。
tags:
  - Upstash
  - Redis
  - 缓存
...
[Upstash](https://upstash.com/) 是一个 Serverless Redis 服务，提供免费额度和按量付费模式，非常适合 Orvilo 部署使用。
...
<Steps>
  ...
  <Image alt={'从 Upstash 复制 Redis URL'} src={'https://hub-apac-1.objects.aspectlylabs.com/docs/43d110283ba816c0c2b45408e4f9d344.png'} />
  ...
  <Callout type={'info'}>
    Upstash 使用 `rediss://`（双's'）表示 TLS 连接，Orvilo 自动支持此格式。
  </Callout>
</Steps>
