---
title: Using InternLM in Orvilo
description: >-
  Learn how to configure and use your InternLM API Key in Orvilo to start
...
This guide will walk you through how to use InternLM within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Orvilo
...
You’re all set! You can now start using InternLM-powered models in Orvilo for conversations and interactions.
