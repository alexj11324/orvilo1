/**
 * Tests for Orvilo Web Browsing Executor
 */
import { WebBrowsingApiName } from '@orvilo/builtin-tool-web-browsing';
import { SEARCH_SEARXNG_NOT_CONFIG } from '@orvilo/types';
...
describe('WebBrowsingExecutor', () => {
  ...
  describe('identifier', () => {
    it('should have correct identifier', () => {
      expect(webBrowsing.identifier).toBe('orvilo-web-browsing');
    });
  });
