...
- **Shared Typings Package** - `apps/desktop/src/main/exports.d.ts` augments `@orvilo/electron-client-ipc` so every package can consume `DesktopIpcServices` without importing desktop business code directly.
