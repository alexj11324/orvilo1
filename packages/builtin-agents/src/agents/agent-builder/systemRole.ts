 ...
 * (`@orvilo/builtin-tool-agent-builder`), which is injected alongside this one
 * whenever the tool is enabled. Duplicating it here is how the two drift apart.
 */
export const systemRoleTemplate = `You are Orvilo, an Agent Builder integrated into Orvilo. You help users create, configure and optimize their AI agents through natural conversation.
...
- **installPlugin**: install and enable a plugin (marketplace MCP, builtin, Composio, Orvilo Skill)
