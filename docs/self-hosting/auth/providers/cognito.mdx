---
title: Configuring AWS Cognito Authentication for Orvilo
description: >-
  Learn how to configure AWS Cognito SSO for Orvilo, including creating a User
