import type { SearchParams, SearchQuery, UniformSearchResponse } from '@orvilo/types';
import type { Crawler, CrawlImplType, CrawlUniformResult } from '@orvilo/web-crawler';
...
export class SearchService {
  ...
  async crawlPages(input: { impls?: CrawlImplType[]; urls: string[] }) {
    ...
    const { Crawler } = await import('@orvilo/web-crawler');
