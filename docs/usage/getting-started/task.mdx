...
title: Task
description: >-
  Learn how to use Tasks in Orvilo to delegate work to agents. Create tasks,
...
![](https://hub-apac-1.objects.aspectlylabs.com/blog/assets4aa1732a45832afc780600e6e329860c.webp)
...
<Steps>
  ...
  Click **Tasks** in the left sidebar to open the task list for your workspace. To see work already assigned to you, open **My issues** instead — see [Inbox and My issues](/docs/usage/getting-started/work).
...
Approvals, assigned lists, saved views, and team triage live on [Inbox and My issues](/docs/usage/getting-started/work). **Tasks**, **Projects**, and **Automation** stay reachable as deep links under Workspace.
