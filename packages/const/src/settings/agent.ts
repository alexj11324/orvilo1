...
export const DEFAUTT_AGENT_TTS_CONFIG: OrviloAgentTTSConfig = {
...
export const DEFAULT_AGENT_CHAT_CONFIG: OrviloAgentChatConfig = {
...
export const DEFAULT_AGENT_CONFIG: OrviloAgentConfig = {
