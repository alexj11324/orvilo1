...
| ----------------------- | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**      | Capabilities built into Orvilo       | Artifacts, Sandbox, GTD, Notebook, Memory |
| **Orvilo Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **Orvilo** — Built-in tools and Orvilo-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. Orvilo Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **Orvilo** tab
...
**Integrations** — Built-in tools, Orvilo-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
