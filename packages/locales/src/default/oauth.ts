export default {
  ...
  'consent.thirdParty.notice':
    'This application is created by a third-party developer and is not operated by Orvilo. Once authorized, it can act on your behalf and use your account quota.',
