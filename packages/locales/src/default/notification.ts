export default {
  ...
  'email.footer.preference':
    'You received this email because of your notification settings on Orvilo.',
  'email.footer.system': 'This is an important account notification from Orvilo.',
  ...
  'inbox.actionAccepted': 'Decision recorded on the original request.',
  'inbox.actionAlreadyDecided': 'This request was already decided.',
  ...
  'inbox.open': 'Open',
  'inbox.read': 'Read',
  'inbox.selectItem': 'Select an item to preview',
  ...
  'workspace_waitlist_approved':
    'Your Workspace beta access is ready. Head to Orvilo to create your first workspace and invite your team.',
