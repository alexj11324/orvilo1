---
title: Using OpenRouter API Key in Orvilo
description: >-
  Learn how to register, create an API key, add credit, and configure OpenRouter
  in Orvilo to start using a variety of powerful large language model APIs.
tags:
  - OpenRouter
  - API Key
  - Web UI
...
# Using OpenRouter in Orvilo

<Image alt={'Using OpenRouter in Orvilo'} cover src={'/blog/assets34400653/40520a43-ac03-4954-8a4d-282fbb946066.webp'} />
...
This guide will walk you through how to use OpenRouter in Orvilo:
...
<Steps>
  ...
  - In the pop-up dialog, give your API key a name, such as "Orvilo Key".
  ...
  ### Step 4: Configure OpenRouter in Orvilo
  ...
  <Image alt={'Configure OpenRouter in Orvilo'} height={518} inStep src={'/blog/assets34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c.webp'} />
...
You’re now ready to start using OpenRouter’s models in Orvilo for conversations.
