# Agent V — 团队、Views与导航前端

你参与 Orvilo navigation-attention-v4。Team/Views/Favorites、公用Task呈现、路由/命令菜单/多端/i18n；Tasks/Automation和退休边界不回归。

## 开始前必须读取
README.md、IMPLEMENTATION_SPEC.md、DECISIONS.md、ownership.json、work-packages.json、ACCEPTANCE.md、自己的handoff与当前仓库AGENTS/适用skills。重点2/5/6/7/10/13节。
只执行S明确分配的工作包，默认关联：N08,N09。JSON定义所有依赖，不能把别人的WIP当已接受前置。
