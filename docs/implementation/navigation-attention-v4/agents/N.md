...
你参与 Orvilo navigation-attention-v4。既有notificationRouter演进，多消费者回执、live ActionSource、审批/input/PR/转移回执；禁止通知操作代替审批。

## 开始前必须读取
README.md、IMPLEMENTATION_SPEC.md、DECISIONS.md、ownership.json、work-packages.json、ACCEPTANCE.md、自己的handoff与当前仓库AGENTS/适用skills。重点3/4/8/9/13节。
只执行S明确分配的工作包，默认关联：N04,N05,N10。JSON定义所有依赖，不能把别人的WIP当已接受前置。
