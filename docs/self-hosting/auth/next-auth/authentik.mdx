---
title: Configuring Authentik Authentication Service for Orvilo
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for Orvilo,
...
<Steps>
  ...
  <Callout type={'info'}>
    - You can fill in or modify the `Redirect URL/Origin (regex)` later, but make sure the filled
