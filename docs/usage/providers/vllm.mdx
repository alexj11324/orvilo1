---
title: Using vLLM API Key in Orvilo
description: >-
  Learn how to configure and use vLLM language models in Orvilo, obtain an API
...
# Using vLLM in Orvilo

<Image alt={'Using vLLM in Orvilo'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in Orvilo:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Orvilo

  - Open the `App Settings` panel in Orvilo
...
You're now ready to use vLLM-powered models in Orvilo for conversations.
