...
/**
 * Why a reviewer rejected a check — see `@orvilo/const/verify` for the reason
 ...
 *  side; see `reviewPredictionActions` in `@orvilo/const/verify`. */
export type ReviewPredictionAction = 'accept' | 'reject' | 'unjudgeable';

/**
 * How a review attempt ended — see `@orvilo/const/verify` for why this is
