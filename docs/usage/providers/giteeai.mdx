---
title: Using Gitee AI in Orvilo
description: >-
  Learn how to configure and use Gitee AI's API Key in Orvilo to start chatting
  and interacting.
tags:
  - Orvilo
  - Gitee AI
...
This guide will walk you through how to use Gitee AI within Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure Gitee AI in Orvilo
...
And that’s it! You’re now ready to use Gitee AI models for conversations in Orvilo.
