// Re-export all types from @orvilo/agent-templates for backward compatibility
...
export type { AgentDocumentPolicy, DocumentLoadRules } from '@orvilo/agent-templates';
