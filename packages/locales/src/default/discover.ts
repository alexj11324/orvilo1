export default {
  ...
  'createGuide.func1.title': 'Submit in Orvilo',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Orvilo Community.',
  'footer.title': 'Share your creation on Orvilo Community today',
  ...
  'models.providerInfo.apiTooltip': 'Orvilo supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Orvilo Official Service',
