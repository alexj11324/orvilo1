---
title: Configuring Logto Authentication for Orvilo
description: >-
  Learn how to configure Logto SSO for Orvilo, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `Orvilo`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for Orvilo. Use `logto` for Logto                                |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to Orvilo.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use Orvilo.
</Callout>
