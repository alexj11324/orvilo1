---
title: Using iFLYTEK Spark in Orvilo
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in Orvilo to start
...
This guide will walk you through how to use iFLYTEK Spark in Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in Orvilo
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in Orvilo.
