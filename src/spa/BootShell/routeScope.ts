 ...
 * render that chrome. `/desktop-onboarding`, `/verify-im` and `/acceptance` are
 * siblings of the main-layout root, not children: showing them a nav panel that
 * never arrives is worse than showing the brand logo they already fall back to.
 *
