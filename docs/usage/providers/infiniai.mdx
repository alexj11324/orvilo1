---
title: Using Infini-AI in Orvilo
description: >-
  Learn how to configure and use Infini-AI's API Key in Orvilo to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into Orvilo.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in Orvilo

  - Open Orvilo and go to the "Settings" page
