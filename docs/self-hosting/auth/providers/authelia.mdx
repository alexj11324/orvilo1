---
title: Configuring Authelia Authentication for Orvilo
description: >-
  Learn how to configure Authelia SSO for Orvilo, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for Orvilo. Use `authelia` for Authelia                          |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use Orvilo.
</Callout>
