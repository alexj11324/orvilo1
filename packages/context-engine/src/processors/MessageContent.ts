...
import { filesPrompts } from '@orvilo/prompts';
import type { ChatAudioItem, MessageContentPart } from '@orvilo/types';
import { normalizeAudioDurationMs } from '@orvilo/utils/audio';
import { imageUrlToBase64 } from '@orvilo/utils/imageToBase64';
import { parseDataUri } from '@orvilo/utils/uriParser';
import { isDesktopLocalStaticServerUrl } from '@orvilo/utils/url';
