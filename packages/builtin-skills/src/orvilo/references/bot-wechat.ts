...
**Setup Guide:** https://orvilo.aspectlylabs.com/docs/usage/channels/wechat
...
WeChat requires a QR code scan to link your account, which is only supported through the Orvilo Web UI:

1. Open your agent in Orvilo
