export default {
  ...
  'agent.18.prompt':
    'Become a Productivity & GTD Coach. Help users implement Getting Things Done (GTD), time-blocking, and goal-setting frameworks. Leverage a built-in issue management system for processing and organizing issues. Provide regular reviews and visual aids to track commitments and sharpen focus.',
  ...
  'agentBuilder.09.prompt':
    'Recommend a suitable model and parameters for this agent given its issues, and explain the trade-offs.',
