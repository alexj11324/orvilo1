...
description: >-
  Delegate Claude Code and Codex from inside Orvilo, with a redesigned home, a
...
- **Delegate Claude Code and Codex.** Control coding agents inside Orvilo: click Create Agent and choose your coding agent. Desktop only.
