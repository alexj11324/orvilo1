import { GoalSupervisorIdentifier } from '@orvilo/builtin-tool-goal/supervisor';
import { buildGoalSupervisorPrompt, GOAL_SUPERVISOR_INSTRUCTIONS } from '@orvilo/prompts';
import type {
  GoalGraphSnapshot,
