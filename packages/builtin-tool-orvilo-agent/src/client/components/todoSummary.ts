...
export const TODO_SUMMARY_LABEL_KEYS = {
  allDone: 'builtins.orvilo-agent.todos.allDone',
  completedStep: 'builtins.orvilo-agent.todos.completedStep',
  idle: 'builtins.orvilo-agent.todos.todos',
  inProgress: 'builtins.orvilo-agent.todos.currentStep',
} as const;
