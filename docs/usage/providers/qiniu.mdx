---
title: Using Qiniu Cloud's Large Language Model API Key in Orvilo
description: >-
  Learn how to configure and use Qiniu Cloud's large language models in Orvilo
...
# Using Qiniu Cloud's Large Language Model in Orvilo

<Image alt={'Using Qiniu Cloud LLM in Orvilo'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />
...
This guide will walk you through how to use Qiniu Cloud's large language models in Orvilo:
...
<Steps>
  ...
  - Method 1: Get it via the Console
    ...
    2. [Go to the Console to retrieve your API Key](https://portal.qiniu.com/ai-inference/api-key)
       <Image alt={'Retrieve API Key'} inStep src={'https://static.sufy.com/orvilo/438758098-119239c1-8552-420a-9906-de2eab739fc6.png'} />
  ...
  ### Step 2: Configure Qiniu Cloud LLM Service in Orvilo

  - Open the Settings panel in Orvilo
  - Under the "AI Providers" section, find the "Qiniu Cloud" configuration

  <Image alt={'Enter API Key'} inStep src={'https://static.sufy.com/orvilo/439049319-6ae44f36-bf48-492a-a6aa-7be72f4a29d8.png'} />
  ...
  <Image alt={'Select Qiniu Cloud LLM and start chatting'} inStep src={'https://static.sufy.com/orvilo/439048945-c608eb9e-6ee1-4611-9df7-2075e95d069b.png'} />
...
That's it! You're now ready to use Qiniu Cloud's large language models in Orvilo for intelligent conversations.
