export default {
  ...
  'storage.actions.copyOrviloAI.button': 'Copy to…',
  'storage.actions.copyOrviloAI.desc':
  ...
  'workspace.general.copyOrviloAI.modal.copyOptions.config.desc':
  ...
  'workspace.general.copyOrviloAI.modal.copyOptions.history.title': 'Topics and messages',
  'workspace.general.copyOrviloAI.modal.copyOptions.knowledgeBase.reason':
  ...
  'workspace.general.copyOrviloAI.modal.loadFailed': 'Failed to load agents',
  'workspace.general.copyOrviloAI.modal.noAgents': 'No agents available to copy',
  'workspace.general.copyOrviloAI.modal.selected': 'selected',
  'workspace.general.copyOrviloAI.modal.selectedAgent':
  ...
  'workspace.general.copyOrviloAI.modal.untitledAgent': 'Untitled Agent',
  ...
  'workspaceSetting.linear.reconnect': 'Reconnect',
  'workspaceSetting.linear.popupBlocked': 'Allow popups to finish Linear authorization.',
  'workspaceSetting.linear.connected': 'Linear connected',
  ...
  'workspaceSetting.linear.importSuccess': 'Linear project import completed',
  'workspaceSetting.linear.importFailed': 'Could not import Linear issues',
  'workspaceSetting.linear.planningTitle': 'Coordinator planning review',
  'workspaceSetting.linear.noProposal': 'No pending proposal for this project.',
  ...
  'workspaceSetting.linear.operations.noError': 'No error detail recorded',
  'workspaceSetting.linear.operations.attempts_one': '{{count}} attempt',
  'workspaceSetting.linear.operations.attempts_other': '{{count}} attempts',
  'workspaceSetting.linear.operations.age': 'Age: {{time}}',
  'workspaceSetting.linear.operations.retry': 'Retry',
  'workspaceSetting.linear.operations.reconnect': 'Reconnect',
  'workspaceSetting.linear.operations.retrySuccess': 'Linear retry queued',
  'workspaceSetting.linear.operations.retryFailed': 'Could not retry the Linear operation',
  ...
  'workspaceSetting.agents.status.running': 'Running',
  'workspaceSetting.invite.acceptAction': 'Accept invitation',
  'workspaceSetting.invite.acceptFailed': 'Failed to accept this invitation.',
  'workspaceSetting.invite.alreadyJoined': 'You already joined this workspace',
  'workspaceSetting.invite.backHome': 'Back to home',
  'workspaceSetting.invite.goToWorkspace': 'Go to workspace',
  'workspaceSetting.invite.invalidLink': 'This invitation link is invalid.',
  'workspaceSetting.invite.invitedBy': 'Invited by {{name}}',
  'workspaceSetting.invite.loadFailed': 'Unable to load this invitation.',
  'workspaceSetting.invite.projectAccess': 'Also grants access to these projects',
  'workspaceSetting.invite.roleLine': 'You will join as {{role}}',
  'workspaceSetting.invite.status.accepted': 'This invitation was already used',
  'workspaceSetting.invite.status.expired': 'This invitation has expired',
  'workspaceSetting.invite.status.revoked': 'This invitation was revoked',
  'workspaceSetting.invite.unknownInviter': 'a teammate',
  'workspaceSetting.invitations.columnEmail': 'Email',
  'workspaceSetting.invitations.columnExpires': 'Expires',
  'workspaceSetting.invitations.columnLastSent': 'Last sent',
  'workspaceSetting.invitations.columnStatus': 'Status',
  'workspaceSetting.invitations.empty': 'No invitations yet.',
  'workspaceSetting.invitations.lastSent': 'Sent {{date}}',
  'workspaceSetting.invitations.loadFailed': "Couldn't load invitations.",
  'workspaceSetting.invitations.resend': 'Resend',
  'workspaceSetting.invitations.revoke': 'Revoke',
  'workspaceSetting.invitations.roleLine': 'Role: {{role}}',
  'workspaceSetting.invitations.status.accepted': 'Accepted',
  'workspaceSetting.invitations.status.expired': 'Expired',
  ...
  'workspaceSetting.members.emailsPlaceholder':
    'name@example.com, teammate@example.com — comma or new-line separated',
  'workspaceSetting.members.empty': 'No members yet.',
  'workspaceSetting.members.invalidEmails': 'Not valid emails: {{emails}}',
  ...
  'workspaceSetting.members.previewDelegations': '{{count}} running delegation',
  'workspaceSetting.members.previewDelegations_other': '{{count}} running delegations',
  'workspaceSetting.members.previewDevices': '{{count}} shared device',
  'workspaceSetting.members.previewDevices_other': '{{count}} shared devices',
  'workspaceSetting.members.previewFailed':
  ...
  'workspaceSetting.members.projectsPlaceholder': 'Select projects (optional)',
  'workspaceSetting.members.reassignLabel': 'Reassign their work to',
  'workspaceSetting.members.reassignPlaceholder': 'Choose a member (optional)',
  'workspaceSetting.members.remove': 'Remove',
  'workspaceSetting.members.removeAction': 'Remove member',
  'workspaceSetting.members.removeTitle': 'Remove {{name}}?',
  'workspaceSetting.members.removeWarning':
    'Removing {{name}} immediately revokes their access to this workspace, its projects, and its agents.',
  'workspaceSetting.members.resume': 'Resume',
  'workspaceSetting.members.role.admin': 'Admin',
  'workspaceSetting.members.role.member': 'Member',
  'workspaceSetting.members.role.owner': 'Owner',
  'workspaceSetting.members.role.viewer': 'Viewer',
  'workspaceSetting.members.scopeExplainer':
    'Invited people join the workspace — they also see other projects shared with the workspace, not just the ones you pick here.',
  'workspaceSetting.members.status.active': 'Active',
  'workspaceSetting.members.status.invited': 'Invited',
  'workspaceSetting.members.status.removed': 'Removed',
  ...
  'workspaceSetting.notification.title': 'Notifications',
  'workspaceSetting.notification.channels': 'Channels',
  'workspaceSetting.notification.inbox': 'In-app inbox',
  ...
  'tools.title': 'Skills',
  'workspaceSetting.tab.imports': 'Imports',
  'workspaceSetting.import.title': 'Imports',
  'workspaceSetting.import.catalogDescription': 'Bring existing work into this workspace.',
  'workspaceSetting.import.linear.title': 'Linear',
  'workspaceSetting.import.backToImports': 'Back to Imports',
  'workspaceSetting.import.progress': 'Import progress',
  'workspaceSetting.import.step.target': 'Configure Orvilo',
  'workspaceSetting.import.step.source': 'Configure Linear',
  'workspaceSetting.import.step.mapping': 'Map States',
  'workspaceSetting.import.step.summary': 'Summary',
  'workspaceSetting.import.targetDescription':
    'First choose the Orvilo project that will receive the Linear issues.',
  'workspaceSetting.import.sourceDescription':
    'Connect Linear, then choose the team whose issues you want to import.',
  'workspaceSetting.import.mappingDescription':
    'Review the suggested category for each Linear state. Every state needs a mapping.',
  'workspaceSetting.import.summaryDescription':
    'Review the data that will be imported into your selected Orvilo project.',
  'workspaceSetting.import.selectProject': 'Select Orvilo project',
  ...
  'workspaceSetting.import.orviloState': 'Orvilo category',
  'workspaceSetting.import.category.backlog': 'Backlog',
  ...
  'workspaceSetting.import.states': 'States',
  'workspaceSetting.import.mappedOnly': 'mapped',
  'workspaceSetting.import.scopeNote':
    'This import copies issues into one Orvilo project and maps their states. Users, cycles, labels, Linear projects, and documents are not imported.',
  'workspaceSetting.import.back': 'Back',
  'workspaceSetting.import.next': 'Next',
  'workspaceSetting.import.confirm': 'Confirm',
  'workspaceSetting.import.loading': 'Loading import details…',
  'workspaceSetting.import.loadFailed': 'Could not load import details. Try again.',
  'workspaceSetting.import.startFailed': 'Could not start the import. Try again.',
  'workspaceSetting.import.resumeFailed': 'Could not resume the import. Try again.',
  'workspaceSetting.import.permissionDenied': 'Only workspace administrators can import data.',
  'workspaceSetting.import.resultTitle': 'Import progress',
  'workspaceSetting.import.resultDescription':
    'You can leave this page and return to check progress.',
  'workspaceSetting.import.status': 'Status',
  'workspaceSetting.import.jobStatus.queued': 'Queued',
  'workspaceSetting.import.jobStatus.running': 'Running',
  'workspaceSetting.import.jobStatus.failed': 'Failed',
  'workspaceSetting.import.jobStatus.completed': 'Completed',
  'workspaceSetting.import.imported': 'Imported',
  'workspaceSetting.import.skipped': 'Skipped',
